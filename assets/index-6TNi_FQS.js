 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,O){var F=D.length;D.push(O);e:for(;0<F;){var q=F-1>>>1,K=D[q];if(0<r(K,O))D[q]=O,D[F]=K,F=q;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var O=D[0],F=D.pop();if(F!==O){D[0]=F;e:for(var q=0,K=D.length,j=K>>>1;q<j;){var Z=2*(q+1)-1,ue=D[Z],ae=Z+1,de=D[ae];if(0>r(ue,F))ae<K&&0>r(de,ue)?(D[q]=de,D[ae]=F,q=ae):(D[q]=ue,D[Z]=F,q=Z);else if(ae<K&&0>r(de,F))D[q]=de,D[ae]=F,q=ae;else break e}}return O}function r(D,O){var F=D.sortIndex-O.sortIndex;return F!==0?F:D.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,d=null,h=3,m=!1,v=!1,x=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(D){for(var O=n(u);O!==null;){if(O.callback===null)i(u);else if(O.startTime<=D)i(u),O.sortIndex=O.expirationTime,e(l,O);else break;O=n(u)}}function y(D){if(x=!1,g(D),!v)if(n(l)!==null)v=!0,W(C);else{var O=n(u);O!==null&&$(y,O.startTime-D)}}function C(D,O){v=!1,x&&(x=!1,c(N),N=-1),m=!0;var F=h;try{for(g(O),d=n(l);d!==null&&(!(d.expirationTime>O)||D&&!B());){var q=d.callback;if(typeof q=="function"){d.callback=null,h=d.priorityLevel;var K=q(d.expirationTime<=O);O=t.unstable_now(),typeof K=="function"?d.callback=K:d===n(l)&&i(l),g(O)}else i(l);d=n(l)}if(d!==null)var j=!0;else{var Z=n(u);Z!==null&&$(y,Z.startTime-O),j=!1}return j}finally{d=null,h=F,m=!1}}var R=!1,w=null,N=-1,M=5,E=-1;function B(){return!(t.unstable_now()-E<M)}function X(){if(w!==null){var D=t.unstable_now();E=D;var O=!0;try{O=w(!0,D)}finally{O?Q():(R=!1,w=null)}}else R=!1}var Q;if(typeof _=="function")Q=function(){_(X)};else if(typeof MessageChannel<"u"){var b=new MessageChannel,k=b.port2;b.port1.onmessage=X,Q=function(){k.postMessage(null)}}else Q=function(){p(X,0)};function W(D){w=D,R||(R=!0,Q())}function $(D,O){N=p(function(){D(t.unstable_now())},O)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,W(C))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(h){case 1:case 2:case 3:var O=3;break;default:O=h}var F=h;h=O;try{return D()}finally{h=F}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,O){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var F=h;h=D;try{return O()}finally{h=F}},t.unstable_scheduleCallback=function(D,O,F){var q=t.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?q+F:q):F=q,D){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=F+K,D={id:f++,callback:O,priorityLevel:D,startTime:F,expirationTime:K,sortIndex:-1},F>q?(D.sortIndex=F,e(u,D),n(l)===null&&D===n(u)&&(x?(c(N),N=-1):x=!0,$(y,F-q))):(D.sortIndex=K,e(l,D),v||m||(v=!0,W(C))),D},t.unstable_shouldYield=B,t.unstable_wrapCallback=function(D){var O=h;return function(){var F=h;h=O;try{return D.apply(this,arguments)}finally{h=F}}}})(tm);em.exports=tm;var h0=em.exports;/**
 * @license React
...
`)}function $T(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(rs).join(`
`)}function KT(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function ZT(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=t.getActiveAttrib(e,r),o=s.name;let a=1;s.type===t.FLOAT_MAT2&&(a=2),s.type===t.FLOAT_MAT3&&(a=3),s.type===t.FLOAT_MAT4&&(a=4),n[o]={type:s.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function rs(t){return t!==""}function Rp(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Cp(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const QT=/^[ \t]*#include +<([\w\d./]+)>/gm;function Wc(t){return t.replace(QT,e1)}const JT=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function e1(t,e){let n=ke[e];if(n===void 0){const i=JT.get(e);if(i!==void 0)n=ke[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Wc(n)}const t1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Pp(t){return t.replace(t1,n1)}function n1(t,e,n,i){let r="";for(let s=parseInt(e);s<parseInt(n);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Lp(t){let e="precision "+t.precision+` float;
precision `+t.precision+" int;";return t.precision==="highp"?e+=`
#define HIGH_PRECISION`:t.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:t.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function i1(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===n_?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===i_?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===ti&&(e="SHADOWMAP_TYPE_VSM"),e}function r1(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case Ms:case Es:e="ENVMAP_TYPE_CUBE";break;case Dl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function s1(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case Es:e="ENVMAP_MODE_REFRACTION";break}return e}function o1(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case r_:e="ENVMAP_BLENDING_MULTIPLY";break;case Gx:e="ENVMAP_BLENDING_MIX";break;case Vx:e="ENVMAP_BLENDING_ADD";break}return e}function a1(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function l1(t,e,n,i){const r=t.getContext(),s=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=i1(n),u=r1(n),f=s1(n),d=o1(n),h=a1(n),m=n.isWebGL2?"":qT(n),v=$T(n),x=KT(s),p=r.createProgram();let c,_,g=n.glslVersion?"#version "+n.glslVersion+`
...
`].filter(rs).join(`
`)),o=Wc(o),o=Rp(o,n),o=Cp(o,n),a=Wc(a),a=Rp(a,n),a=Cp(a,n),o=Pp(o),a=Pp(a),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(g=`#version 300 es
...
}`;function A1(t,e,n){let i=new jf;const r=new Ne,s=new Ne,o=new ot,a=new M1({depthPacking:oy}),l=new E1,u={},f=n.maxTextureSize,d={[Wi]:rn,[rn]:Wi,[ri]:ri},h=new Sr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ne},radius:{value:4}},vertexShader:T1,fragmentShader:w1}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const v=new mi;v.setAttribute("position",new qn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new bt(v,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=n_;let c=this.type;this.render=function(R,w,N){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;const M=t.getRenderTarget(),E=t.getActiveCubeFace(),B=t.getActiveMipmapLevel(),X=t.state;X.setBlending(ki),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const Q=c!==ti&&this.type===ti,b=c===ti&&this.type!==ti;for(let k=0,W=R.length;k<W;k++){const $=R[k],D=$.shadow;if(D===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(D.autoUpdate===!1&&D.needsUpdate===!1)continue;r.copy(D.mapSize);const O=D.getFrameExtents();if(r.multiply(O),s.copy(D.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/O.x),r.x=s.x*O.x,D.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/O.y),r.y=s.y*O.y,D.mapSize.y=s.y)),D.map===null||Q===!0||b===!0){const q=this.type!==ti?{minFilter:qt,magFilter:qt}:{};D.map!==null&&D.map.dispose(),D.map=new vr(r.x,r.y,q),D.map.texture.name=$.name+".shadowMap",D.camera.updateProjectionMatrix()}t.setRenderTarget(D.map),t.clear();const F=D.getViewportCount();for(let q=0;q<F;q++){const K=D.getViewport(q);o.set(s.x*K.x,s.y*K.y,s.x*K.z,s.y*K.w),X.viewport(o),D.updateMatrices($,q),i=D.getFrustum(),y(w,N,D.camera,$,this.type)}D.isPointLightShadow!==!0&&this.type===ti&&_(D,N),D.needsUpdate=!1}c=this.type,p.needsUpdate=!1,t.setRenderTarget(M,E,B)};function _(R,w){const N=e.update(x);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new vr(r.x,r.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,t.setRenderTarget(R.mapPass),t.clear(),t.renderBufferDirect(w,null,N,h,x,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,t.setRenderTarget(R.map),t.clear(),t.renderBufferDirect(w,null,N,m,x,null)}function g(R,w,N,M){let E=null;const B=N.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(B!==void 0)E=B;else if(E=N.isPointLight===!0?l:a,t.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const X=E.uuid,Q=w.uuid;let b=u[X];b===void 0&&(b={},u[X]=b);let k=b[Q];k===void 0&&(k=E.clone(),b[Q]=k,w.addEventListener("dispose",C)),E=k}if(E.visible=w.visible,E.wireframe=w.wireframe,M===ti?E.side=w.shadowSide!==null?w.shadowSide:w.side:E.side=w.shadowSide!==null?w.shadowSide:d[w.side],E.alphaMap=w.alphaMap,E.alphaTest=w.alphaTest,E.map=w.map,E.clipShadows=w.clipShadows,E.clippingPlanes=w.clippingPlanes,E.clipIntersection=w.clipIntersection,E.displacementMap=w.displacementMap,E.displacementScale=w.displacementScale,E.displacementBias=w.displacementBias,E.wireframeLinewidth=w.wireframeLinewidth,E.linewidth=w.linewidth,N.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const X=t.properties.get(E);X.light=N}return E}function y(R,w,N,M,E){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&E===ti)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,R.matrixWorld);const Q=e.update(R),b=R.material;if(Array.isArray(b)){const k=Q.groups;for(let W=0,$=k.length;W<$;W++){const D=k[W],O=b[D.materialIndex];if(O&&O.visible){const F=g(R,O,M,E);R.onBeforeShadow(t,R,w,N,Q,F,D),t.renderBufferDirect(N,null,Q,F,R,D),R.onAfterShadow(t,R,w,N,Q,F,D)}}}else if(b.visible){const k=g(R,b,M,E);R.onBeforeShadow(t,R,w,N,Q,k,null),t.renderBufferDirect(N,null,Q,k,R,null),R.onAfterShadow(t,R,w,N,Q,k,null)}}const X=R.children;for(let Q=0,b=X.length;Q<b;Q++)y(X[Q],w,N,M,E)}function C(R){R.target.removeEventListener("dispose",C);for(const N in u){const M=u[N],E=R.target.uuid;E in M&&(M[E].dispose(),delete M[E])}}}function R1(t,e,n){const i=n.isWebGL2;function r(){let L=!1;const oe=new ot;let ce=null;const Pe=new ot(0,0,0,0);return{setMask:function(Te){ce!==Te&&!L&&(t.colorMask(Te,Te,Te,Te),ce=Te)},setLocked:function(Te){L=Te},setClear:function(Te,Xe,je,ft,pt){pt===!0&&(Te*=ft,Xe*=ft,je*=ft),oe.set(Te,Xe,je,ft),Pe.equals(oe)===!1&&(t.clearColor(Te,Xe,je,ft),Pe.copy(oe))},reset:function(){L=!1,ce=null,Pe.set(-1,0,0,0)}}}function s(){let L=!1,oe=null,ce=null,Pe=null;return{setTest:function(Te){Te?Ce(t.DEPTH_TEST):we(t.DEPTH_TEST)},setMask:function(Te){oe!==Te&&!L&&(t.depthMask(Te),oe=Te)},setFunc:function(Te){if(ce!==Te){switch(Te){case Ix:t.depthFunc(t.NEVER);break;case Ox:t.depthFunc(t.ALWAYS);break;case Fx:t.depthFunc(t.LESS);break;case cl:t.depthFunc(t.LEQUAL);break;case zx:t.depthFunc(t.EQUAL);break;case kx:t.depthFunc(t.GEQUAL);break;case Bx:t.depthFunc(t.GREATER);break;case Hx:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ce=Te}},setLocked:function(Te){L=Te},setClear:function(Te){Pe!==Te&&(t.clearDepth(Te),Pe=Te)},reset:function(){L=!1,oe=null,ce=null,Pe=null}}}function o(){let L=!1,oe=null,ce=null,Pe=null,Te=null,Xe=null,je=null,ft=null,pt=null;return{setTest:function($e){L||($e?Ce(t.STENCIL_TEST):we(t.STENCIL_TEST))},setMask:function($e){oe!==$e&&!L&&(t.stencilMask($e),oe=$e)},setFunc:function($e,_t,Bn){(ce!==$e||Pe!==_t||Te!==Bn)&&(t.stencilFunc($e,_t,Bn),ce=$e,Pe=_t,Te=Bn)},setOp:function($e,_t,Bn){(Xe!==$e||je!==_t||ft!==Bn)&&(t.stencilOp($e,_t,Bn),Xe=$e,je=_t,ft=Bn)},setLocked:function($e){L=$e},setClear:function($e){pt!==$e&&(t.clearStencil($e),pt=$e)},reset:function(){L=!1,oe=null,ce=null,Pe=null,Te=null,Xe=null,je=null,ft=null,pt=null}}}const a=new r,l=new s,u=new o,f=new WeakMap,d=new WeakMap;let h={},m={},v=new WeakMap,x=[],p=null,c=!1,_=null,g=null,y=null,C=null,R=null,w=null,N=null,M=new Ke(0,0,0),E=0,B=!1,X=null,Q=null,b=null,k=null,W=null;const $=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let D=!1,O=0;const F=t.getParameter(t.VERSION);F.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(F)[1]),D=O>=1):F.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),D=O>=2);let q=null,K={};const j=t.getParameter(t.SCISSOR_BOX),Z=t.getParameter(t.VIEWPORT),ue=new ot().fromArray(j),ae=new ot().fromArray(Z);function de(L,oe,ce,Pe){const Te=new Uint8Array(4),Xe=t.createTexture();t.bindTexture(L,Xe),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let je=0;je<ce;je++)i&&(L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY)?t.texImage3D(oe,0,t.RGBA,1,1,Pe,0,t.RGBA,t.UNSIGNED_BYTE,Te):t.texImage2D(oe+je,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Te);return Xe}const Re={};Re[t.TEXTURE_2D]=de(t.TEXTURE_2D,t.TEXTURE_2D,1),Re[t.TEXTURE_CUBE_MAP]=de(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Re[t.TEXTURE_2D_ARRAY]=de(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),Re[t.TEXTURE_3D]=de(t.TEXTURE_3D,t.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),u.setClear(0),Ce(t.DEPTH_TEST),l.setFunc(cl),Oe(!1),A(ph),Ce(t.CULL_FACE),ve(ki);function Ce(L){h[L]!==!0&&(t.enable(L),h[L]=!0)}function we(L){h[L]!==!1&&(t.disable(L),h[L]=!1)}function Ge(L,oe){return m[L]!==oe?(t.bindFramebuffer(L,oe),m[L]=oe,i&&(L===t.DRAW_FRAMEBUFFER&&(m[t.FRAMEBUFFER]=oe),L===t.FRAMEBUFFER&&(m[t.DRAW_FRAMEBUFFER]=oe)),!0):!1}function H(L,oe){let ce=x,Pe=!1;if(L)if(ce=v.get(oe),ce===void 0&&(ce=[],v.set(oe,ce)),L.isWebGLMultipleRenderTargets){const Te=L.texture;if(ce.length!==Te.length||ce[0]!==t.COLOR_ATTACHMENT0){for(let Xe=0,je=Te.length;Xe<je;Xe++)ce[Xe]=t.COLOR_ATTACHMENT0+Xe;ce.length=Te.length,Pe=!0}}else ce[0]!==t.COLOR_ATTACHMENT0&&(ce[0]=t.COLOR_ATTACHMENT0,Pe=!0);else ce[0]!==t.BACK&&(ce[0]=t.BACK,Pe=!0);Pe&&(n.isWebGL2?t.drawBuffers(ce):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(ce))}function Pt(L){return p!==L?(t.useProgram(L),p=L,!0):!1}const Ee={[ir]:t.FUNC_ADD,[yx]:t.FUNC_SUBTRACT,[Sx]:t.FUNC_REVERSE_SUBTRACT};if(i)Ee[vh]=t.MIN,Ee[xh]=t.MAX;else{const L=e.get("EXT_blend_minmax");L!==null&&(Ee[vh]=L.MIN_EXT,Ee[xh]=L.MAX_EXT)}const be={[Mx]:t.ZERO,[Ex]:t.ONE,[Tx]:t.SRC_COLOR,[Fc]:t.SRC_ALPHA,[Lx]:t.SRC_ALPHA_SATURATE,[Cx]:t.DST_COLOR,[Ax]:t.DST_ALPHA,[wx]:t.ONE_MINUS_SRC_COLOR,[zc]:t.ONE_MINUS_SRC_ALPHA,[Px]:t.ONE_MINUS_DST_COLOR,[Rx]:t.ONE_MINUS_DST_ALPHA,[bx]:t.CONSTANT_COLOR,[Dx]:t.ONE_MINUS_CONSTANT_COLOR,[Ux]:t.CONSTANT_ALPHA,[Nx]:t.ONE_MINUS_CONSTANT_ALPHA};function ve(L,oe,ce,Pe,Te,Xe,je,ft,pt,$e){if(L===ki){c===!0&&(we(t.BLEND),c=!1);return}if(c===!1&&(Ce(t.BLEND),c=!0),L!==xx){if(L!==_||$e!==B){if((g!==ir||R!==ir)&&(t.blendEquation(t.FUNC_ADD),g=ir,R=ir),$e)switch(L){case hs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mh:t.blendFunc(t.ONE,t.ONE);break;case gh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case _h:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case hs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case mh:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case gh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case _h:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}y=null,C=null,w=null,N=null,M.set(0,0,0),E=0,_=L,B=$e}return}Te=Te||oe,Xe=Xe||ce,je=je||Pe,(oe!==g||Te!==R)&&(t.blendEquationSeparate(Ee[oe],Ee[Te]),g=oe,R=Te),(ce!==y||Pe!==C||Xe!==w||je!==N)&&(t.blendFuncSeparate(be[ce],be[Pe],be[Xe],be[je]),y=ce,C=Pe,w=Xe,N=je),(ft.equals(M)===!1||pt!==E)&&(t.blendColor(ft.r,ft.g,ft.b,pt),M.copy(ft),E=pt),_=L,B=!1}function tt(L,oe){L.side===ri?we(t.CULL_FACE):Ce(t.CULL_FACE);let ce=L.side===rn;oe&&(ce=!ce),Oe(ce),L.blending===hs&&L.transparent===!1?ve(ki):ve(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),l.setFunc(L.depthFunc),l.setTest(L.depthTest),l.setMask(L.depthWrite),a.setMask(L.colorWrite);const Pe=L.stencilWrite;u.setTest(Pe),Pe&&(u.setMask(L.stencilWriteMask),u.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),u.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),z(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Ce(t.SAMPLE_ALPHA_TO_COVERAGE):we(t.SAMPLE_ALPHA_TO_COVERAGE)}function Oe(L){X!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),X=L)}function A(L){L!==_x?(Ce(t.CULL_FACE),L!==Q&&(L===ph?t.cullFace(t.BACK):L===vx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):we(t.CULL_FACE),Q=L}function S(L){L!==b&&(D&&t.lineWidth(L),b=L)}function z(L,oe,ce){L?(Ce(t.POLYGON_OFFSET_FILL),(k!==oe||W!==ce)&&(t.polygonOffset(oe,ce),k=oe,W=ce)):we(t.POLYGON_OFFSET_FILL)}function ie(L){L?Ce(t.SCISSOR_TEST):we(t.SCISSOR_TEST)}function ee(L){L===void 0&&(L=t.TEXTURE0+$-1),q!==L&&(t.activeTexture(L),q=L)}function re(L,oe,ce){ce===void 0&&(q===null?ce=t.TEXTURE0+$-1:ce=q);let Pe=K[ce];Pe===void 0&&(Pe={type:void 0,texture:void 0},K[ce]=Pe),(Pe.type!==L||Pe.texture!==oe)&&(q!==ce&&(t.activeTexture(ce),q=ce),t.bindTexture(L,oe||Re[L]),Pe.type=L,Pe.texture=oe)}function xe(){const L=K[q];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function fe(){try{t.compressedTexImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _e(){try{t.compressedTexImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ae(){try{t.texSubImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Fe(){try{t.texSubImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ze(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Be(){try{t.texStorage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function De(){try{t.texStorage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Me(){try{t.texImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function he(){try{t.texImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function P(L){ue.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),ue.copy(L))}function se(L){ae.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),ae.copy(L))}function ye(L,oe){let ce=d.get(oe);ce===void 0&&(ce=new WeakMap,d.set(oe,ce));let Pe=ce.get(L);Pe===void 0&&(Pe=t.getUniformBlockIndex(oe,L.name),ce.set(L,Pe))}function ge(L,oe){const Pe=d.get(oe).get(L);f.get(oe)!==Pe&&(t.uniformBlockBinding(oe,Pe,L.__bindingPointIndex),f.set(oe,Pe))}function te(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),i===!0&&(t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null)),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),h={},q=null,K={},m={},v=new WeakMap,x=[],p=null,c=!1,_=null,g=null,y=null,C=null,R=null,w=null,N=null,M=new Ke(0,0,0),E=0,B=!1,X=null,Q=null,b=null,k=null,W=null,ue.set(0,0,t.canvas.width,t.canvas.height),ae.set(0,0,t.canvas.width,t.canvas.height),a.reset(),l.reset(),u.reset()}return{buffers:{color:a,depth:l,stencil:u},enable:Ce,disable:we,bindFramebuffer:Ge,drawBuffers:H,useProgram:Pt,setBlending:ve,setMaterial:tt,setFlipSided:Oe,setCullFace:A,setLineWidth:S,setPolygonOffset:z,setScissorTest:ie,activeTexture:ee,bindTexture:re,unbindTexture:xe,compressedTexImage2D:fe,compressedTexImage3D:_e,texImage2D:Me,texImage3D:he,updateUBOMapping:ye,uniformBlockBinding:ge,texStorage2D:Be,texStorage3D:De,texSubImage2D:Ae,texSubImage3D:Fe,compressedTexSubImage2D:J,compressedTexSubImage3D:Ze,scissor:P,viewport:se,reset:te}}function C1(t,e,n,i,r,s,o){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),f=new WeakMap;let d;const h=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(A,S){return m?new OffscreenCanvas(A,S):Po("canvas")}function x(A,S,z,ie){let ee=1;if((A.width>ie||A.height>ie)&&(ee=ie/Math.max(A.width,A.height)),ee<1||S===!0)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap){const re=S?ml:Math.floor,xe=re(ee*A.width),fe=re(ee*A.height);d===void 0&&(d=v(xe,fe));const _e=z?v(xe,fe):d;return _e.width=xe,_e.height=fe,_e.getContext("2d").drawImage(A,0,0,xe,fe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+A.width+"x"+A.height+") to ("+xe+"x"+fe+")."),_e}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+A.width+"x"+A.height+")."),A;return A}function p(A){return Vc(A.width)&&Vc(A.height)}function c(A){return a?!1:A.wrapS!==In||A.wrapT!==In||A.minFilter!==qt&&A.minFilter!==yn}function _(A,S){return A.generateMipmaps&&S&&A.minFilter!==qt&&A.minFilter!==yn}function g(A){t.generateMipmap(A)}function y(A,S,z,ie,ee=!1){if(a===!1)return S;if(A!==null){if(t[A]!==void 0)return t[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let re=S;if(S===t.RED&&(z===t.FLOAT&&(re=t.R32F),z===t.HALF_FLOAT&&(re=t.R16F),z===t.UNSIGNED_BYTE&&(re=t.R8)),S===t.RED_INTEGER&&(z===t.UNSIGNED_BYTE&&(re=t.R8UI),z===t.UNSIGNED_SHORT&&(re=t.R16UI),z===t.UNSIGNED_INT&&(re=t.R32UI),z===t.BYTE&&(re=t.R8I),z===t.SHORT&&(re=t.R16I),z===t.INT&&(re=t.R32I)),S===t.RG&&(z===t.FLOAT&&(re=t.RG32F),z===t.HALF_FLOAT&&(re=t.RG16F),z===t.UNSIGNED_BYTE&&(re=t.RG8)),S===t.RGBA){const xe=ee?fl:Je.getTransfer(ie);z===t.FLOAT&&(re=t.RGBA32F),z===t.HALF_FLOAT&&(re=t.RGBA16F),z===t.UNSIGNED_BYTE&&(re=xe===it?t.SRGB8_ALPHA8:t.RGBA8),z===t.UNSIGNED_SHORT_4_4_4_4&&(re=t.RGBA4),z===t.UNSIGNED_SHORT_5_5_5_1&&(re=t.RGB5_A1)}return(re===t.R16F||re===t.R32F||re===t.RG16F||re===t.RG32F||re===t.RGBA16F||re===t.RGBA32F)&&e.get("EXT_color_buffer_float"),re}function C(A,S,z){return _(A,z)===!0||A.isFramebufferTexture&&A.minFilter!==qt&&A.minFilter!==yn?Math.log2(Math.max(S.width,S.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?S.mipmaps.length:1}function R(A){return A===qt||A===yh||A===du?t.NEAREST:t.LINEAR}function w(A){const S=A.target;S.removeEventListener("dispose",w),M(S),S.isVideoTexture&&f.delete(S)}function N(A){const S=A.target;S.removeEventListener("dispose",N),B(S)}function M(A){const S=i.get(A);if(S.__webglInit===void 0)return;const z=A.source,ie=h.get(z);if(ie){const ee=ie[S.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&E(A),Object.keys(ie).length===0&&h.delete(z)}i.remove(A)}function E(A){const S=i.get(A);t.deleteTexture(S.__webglTexture);const z=A.source,ie=h.get(z);delete ie[S.__cacheKey],o.memory.textures--}function B(A){const S=A.texture,z=i.get(A),ie=i.get(S);if(ie.__webglTexture!==void 0&&(t.deleteTexture(ie.__webglTexture),o.memory.textures--),A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(z.__webglFramebuffer[ee]))for(let re=0;re<z.__webglFramebuffer[ee].length;re++)t.deleteFramebuffer(z.__webglFramebuffer[ee][re]);else t.deleteFramebuffer(z.__webglFramebuffer[ee]);z.__webglDepthbuffer&&t.deleteRenderbuffer(z.__webglDepthbuffer[ee])}else{if(Array.isArray(z.__webglFramebuffer))for(let ee=0;ee<z.__webglFramebuffer.length;ee++)t.deleteFramebuffer(z.__webglFramebuffer[ee]);else t.deleteFramebuffer(z.__webglFramebuffer);if(z.__webglDepthbuffer&&t.deleteRenderbuffer(z.__webglDepthbuffer),z.__webglMultisampledFramebuffer&&t.deleteFramebuffer(z.__webglMultisampledFramebuffer),z.__webglColorRenderbuffer)for(let ee=0;ee<z.__webglColorRenderbuffer.length;ee++)z.__webglColorRenderbuffer[ee]&&t.deleteRenderbuffer(z.__webglColorRenderbuffer[ee]);z.__webglDepthRenderbuffer&&t.deleteRenderbuffer(z.__webglDepthRenderbuffer)}if(A.isWebGLMultipleRenderTargets)for(let ee=0,re=S.length;ee<re;ee++){const xe=i.get(S[ee]);xe.__webglTexture&&(t.deleteTexture(xe.__webglTexture),o.memory.textures--),i.remove(S[ee])}i.remove(S),i.remove(A)}let X=0;function Q(){X=0}function b(){const A=X;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),X+=1,A}function k(A){const S=[];return S.push(A.wrapS),S.push(A.wrapT),S.push(A.wrapR||0),S.push(A.magFilter),S.push(A.minFilter),S.push(A.anisotropy),S.push(A.internalFormat),S.push(A.format),S.push(A.type),S.push(A.generateMipmaps),S.push(A.premultiplyAlpha),S.push(A.flipY),S.push(A.unpackAlignment),S.push(A.colorSpace),S.join()}function W(A,S){const z=i.get(A);if(A.isVideoTexture&&tt(A),A.isRenderTargetTexture===!1&&A.version>0&&z.__version!==A.version){const ie=A.image;if(ie===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ue(z,A,S);return}}n.bindTexture(t.TEXTURE_2D,z.__webglTexture,t.TEXTURE0+S)}function $(A,S){const z=i.get(A);if(A.version>0&&z.__version!==A.version){ue(z,A,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,z.__webglTexture,t.TEXTURE0+S)}function D(A,S){const z=i.get(A);if(A.version>0&&z.__version!==A.version){ue(z,A,S);return}n.bindTexture(t.TEXTURE_3D,z.__webglTexture,t.TEXTURE0+S)}function O(A,S){const z=i.get(A);if(A.version>0&&z.__version!==A.version){ae(z,A,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture,t.TEXTURE0+S)}const F={[bn]:t.REPEAT,[In]:t.CLAMP_TO_EDGE,[Hc]:t.MIRRORED_REPEAT},q={[qt]:t.NEAREST,[yh]:t.NEAREST_MIPMAP_NEAREST,[du]:t.NEAREST_MIPMAP_LINEAR,[yn]:t.LINEAR,[Kx]:t.LINEAR_MIPMAP_NEAREST,[Ao]:t.LINEAR_MIPMAP_LINEAR},K={[ly]:t.NEVER,[py]:t.ALWAYS,[uy]:t.LESS,[m_]:t.LEQUAL,[cy]:t.EQUAL,[hy]:t.GEQUAL,[fy]:t.GREATER,[dy]:t.NOTEQUAL};function j(A,S,z){if(z?(t.texParameteri(A,t.TEXTURE_WRAP_S,F[S.wrapS]),t.texParameteri(A,t.TEXTURE_WRAP_T,F[S.wrapT]),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,F[S.wrapR]),t.texParameteri(A,t.TEXTURE_MAG_FILTER,q[S.magFilter]),t.texParameteri(A,t.TEXTURE_MIN_FILTER,q[S.minFilter])):(t.texParameteri(A,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(A,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),(S.wrapS!==In||S.wrapT!==In)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),t.texParameteri(A,t.TEXTURE_MAG_FILTER,R(S.magFilter)),t.texParameteri(A,t.TEXTURE_MIN_FILTER,R(S.minFilter)),S.minFilter!==qt&&S.minFilter!==yn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),S.compareFunction&&(t.texParameteri(A,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(A,t.TEXTURE_COMPARE_FUNC,K[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ie=e.get("EXT_texture_filter_anisotropic");if(S.magFilter===qt||S.minFilter!==du&&S.minFilter!==Ao||S.type===Li&&e.has("OES_texture_float_linear")===!1||a===!1&&S.type===Ro&&e.has("OES_texture_half_float_linear")===!1)return;(S.anisotropy>1||i.get(S).__currentAnisotropy)&&(t.texParameterf(A,ie.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy)}}function Z(A,S){let z=!1;A.__webglInit===void 0&&(A.__webglInit=!0,S.addEventListener("dispose",w));const ie=S.source;let ee=h.get(ie);ee===void 0&&(ee={},h.set(ie,ee));const re=k(S);if(re!==A.__cacheKey){ee[re]===void 0&&(ee[re]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,z=!0),ee[re].usedTimes++;const xe=ee[A.__cacheKey];xe!==void 0&&(ee[A.__cacheKey].usedTimes--,xe.usedTimes===0&&E(S)),A.__cacheKey=re,A.__webglTexture=ee[re].texture}return z}function ue(A,S,z){let ie=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(ie=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(ie=t.TEXTURE_3D);const ee=Z(A,S),re=S.source;n.bindTexture(ie,A.__webglTexture,t.TEXTURE0+z);const xe=i.get(re);if(re.version!==xe.__version||ee===!0){n.activeTexture(t.TEXTURE0+z);const fe=Je.getPrimaries(Je.workingColorSpace),_e=S.colorSpace===Sn?null:Je.getPrimaries(S.colorSpace),Ae=S.colorSpace===Sn||fe===_e?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const Fe=c(S)&&p(S.image)===!1;let J=x(S.image,Fe,!1,r.maxTextureSize);J=Oe(S,J);const Ze=p(J)||a,Be=s.convert(S.format,S.colorSpace);let De=s.convert(S.type),Me=y(S.internalFormat,Be,De,S.colorSpace,S.isVideoTexture);j(ie,S,Ze);let he;const P=S.mipmaps,se=a&&S.isVideoTexture!==!0&&Me!==d_,ye=xe.__version===void 0||ee===!0,ge=C(S,J,Ze);if(S.isDepthTexture)Me=t.DEPTH_COMPONENT,a?S.type===Li?Me=t.DEPTH_COMPONENT32F:S.type===Pi?Me=t.DEPTH_COMPONENT24:S.type===cr?Me=t.DEPTH24_STENCIL8:Me=t.DEPTH_COMPONENT16:S.type===Li&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),S.format===fr&&Me===t.DEPTH_COMPONENT&&S.type!==Gf&&S.type!==Pi&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),S.type=Pi,De=s.convert(S.type)),S.format===Ts&&Me===t.DEPTH_COMPONENT&&(Me=t.DEPTH_STENCIL,S.type!==cr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),S.type=cr,De=s.convert(S.type))),ye&&(se?n.texStorage2D(t.TEXTURE_2D,1,Me,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,Me,J.width,J.height,0,Be,De,null));else if(S.isDataTexture)if(P.length>0&&Ze){se&&ye&&n.texStorage2D(t.TEXTURE_2D,ge,Me,P[0].width,P[0].height);for(let te=0,L=P.length;te<L;te++)he=P[te],se?n.texSubImage2D(t.TEXTURE_2D,te,0,0,he.width,he.height,Be,De,he.data):n.texImage2D(t.TEXTURE_2D,te,Me,he.width,he.height,0,Be,De,he.data);S.generateMipmaps=!1}else se?(ye&&n.texStorage2D(t.TEXTURE_2D,ge,Me,J.width,J.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,J.width,J.height,Be,De,J.data)):n.texImage2D(t.TEXTURE_2D,0,Me,J.width,J.height,0,Be,De,J.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){se&&ye&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ge,Me,P[0].width,P[0].height,J.depth);for(let te=0,L=P.length;te<L;te++)he=P[te],S.format!==On?Be!==null?se?n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,te,0,0,0,he.width,he.height,J.depth,Be,he.data,0,0):n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,te,Me,he.width,he.height,J.depth,0,he.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):se?n.texSubImage3D(t.TEXTURE_2D_ARRAY,te,0,0,0,he.width,he.height,J.depth,Be,De,he.data):n.texImage3D(t.TEXTURE_2D_ARRAY,te,Me,he.width,he.height,J.depth,0,Be,De,he.data)}else{se&&ye&&n.texStorage2D(t.TEXTURE_2D,ge,Me,P[0].width,P[0].height);for(let te=0,L=P.length;te<L;te++)he=P[te],S.format!==On?Be!==null?se?n.compressedTexSubImage2D(t.TEXTURE_2D,te,0,0,he.width,he.height,Be,he.data):n.compressedTexImage2D(t.TEXTURE_2D,te,Me,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):se?n.texSubImage2D(t.TEXTURE_2D,te,0,0,he.width,he.height,Be,De,he.data):n.texImage2D(t.TEXTURE_2D,te,Me,he.width,he.height,0,Be,De,he.data)}else if(S.isDataArrayTexture)se?(ye&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ge,Me,J.width,J.height,J.depth),n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,Be,De,J.data)):n.texImage3D(t.TEXTURE_2D_ARRAY,0,Me,J.width,J.height,J.depth,0,Be,De,J.data);else if(S.isData3DTexture)se?(ye&&n.texStorage3D(t.TEXTURE_3D,ge,Me,J.width,J.height,J.depth),n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,Be,De,J.data)):n.texImage3D(t.TEXTURE_3D,0,Me,J.width,J.height,J.depth,0,Be,De,J.data);else if(S.isFramebufferTexture){if(ye)if(se)n.texStorage2D(t.TEXTURE_2D,ge,Me,J.width,J.height);else{let te=J.width,L=J.height;for(let oe=0;oe<ge;oe++)n.texImage2D(t.TEXTURE_2D,oe,Me,te,L,0,Be,De,null),te>>=1,L>>=1}}else if(P.length>0&&Ze){se&&ye&&n.texStorage2D(t.TEXTURE_2D,ge,Me,P[0].width,P[0].height);for(let te=0,L=P.length;te<L;te++)he=P[te],se?n.texSubImage2D(t.TEXTURE_2D,te,0,0,Be,De,he):n.texImage2D(t.TEXTURE_2D,te,Me,Be,De,he);S.generateMipmaps=!1}else se?(ye&&n.texStorage2D(t.TEXTURE_2D,ge,Me,J.width,J.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,Be,De,J)):n.texImage2D(t.TEXTURE_2D,0,Me,Be,De,J);_(S,Ze)&&g(ie),xe.__version=re.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function ae(A,S,z){if(S.image.length!==6)return;const ie=Z(A,S),ee=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,A.__webglTexture,t.TEXTURE0+z);const re=i.get(ee);if(ee.version!==re.__version||ie===!0){n.activeTexture(t.TEXTURE0+z);const xe=Je.getPrimaries(Je.workingColorSpace),fe=S.colorSpace===Sn?null:Je.getPrimaries(S.colorSpace),_e=S.colorSpace===Sn||xe===fe?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);const Ae=S.isCompressedTexture||S.image[0].isCompressedTexture,Fe=S.image[0]&&S.image[0].isDataTexture,J=[];for(let te=0;te<6;te++)!Ae&&!Fe?J[te]=x(S.image[te],!1,!0,r.maxCubemapSize):J[te]=Fe?S.image[te].image:S.image[te],J[te]=Oe(S,J[te]);const Ze=J[0],Be=p(Ze)||a,De=s.convert(S.format,S.colorSpace),Me=s.convert(S.type),he=y(S.internalFormat,De,Me,S.colorSpace),P=a&&S.isVideoTexture!==!0,se=re.__version===void 0||ie===!0;let ye=C(S,Ze,Be);j(t.TEXTURE_CUBE_MAP,S,Be);let ge;if(Ae){P&&se&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,he,Ze.width,Ze.height);for(let te=0;te<6;te++){ge=J[te].mipmaps;for(let L=0;L<ge.length;L++){const oe=ge[L];S.format!==On?De!==null?P?n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L,0,0,oe.width,oe.height,De,oe.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L,he,oe.width,oe.height,0,oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L,0,0,oe.width,oe.height,De,Me,oe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L,he,oe.width,oe.height,0,De,Me,oe.data)}}}else{ge=S.mipmaps,P&&se&&(ge.length>0&&ye++,n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,he,J[0].width,J[0].height));for(let te=0;te<6;te++)if(Fe){P?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,J[te].width,J[te].height,De,Me,J[te].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,he,J[te].width,J[te].height,0,De,Me,J[te].data);for(let L=0;L<ge.length;L++){const ce=ge[L].image[te].image;P?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L+1,0,0,ce.width,ce.height,De,Me,ce.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L+1,he,ce.width,ce.height,0,De,Me,ce.data)}}else{P?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,De,Me,J[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,he,De,Me,J[te]);for(let L=0;L<ge.length;L++){const oe=ge[L];P?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L+1,0,0,De,Me,oe.image[te]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+te,L+1,he,De,Me,oe.image[te])}}}_(S,Be)&&g(t.TEXTURE_CUBE_MAP),re.__version=ee.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function de(A,S,z,ie,ee,re){const xe=s.convert(z.format,z.colorSpace),fe=s.convert(z.type),_e=y(z.internalFormat,xe,fe,z.colorSpace);if(!i.get(S).__hasExternalTextures){const Fe=Math.max(1,S.width>>re),J=Math.max(1,S.height>>re);ee===t.TEXTURE_3D||ee===t.TEXTURE_2D_ARRAY?n.texImage3D(ee,re,_e,Fe,J,S.depth,0,xe,fe,null):n.texImage2D(ee,re,_e,Fe,J,0,xe,fe,null)}n.bindFramebuffer(t.FRAMEBUFFER,A),ve(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ie,ee,i.get(z).__webglTexture,0,be(S)):(ee===t.TEXTURE_2D||ee>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ie,ee,i.get(z).__webglTexture,re),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Re(A,S,z){if(t.bindRenderbuffer(t.RENDERBUFFER,A),S.depthBuffer&&!S.stencilBuffer){let ie=a===!0?t.DEPTH_COMPONENT24:t.DEPTH_COMPONENT16;if(z||ve(S)){const ee=S.depthTexture;ee&&ee.isDepthTexture&&(ee.type===Li?ie=t.DEPTH_COMPONENT32F:ee.type===Pi&&(ie=t.DEPTH_COMPONENT24));const re=be(S);ve(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,re,ie,S.width,S.height):t.renderbufferStorageMultisample(t.RENDERBUFFER,re,ie,S.width,S.height)}else t.renderbufferStorage(t.RENDERBUFFER,ie,S.width,S.height);t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.RENDERBUFFER,A)}else if(S.depthBuffer&&S.stencilBuffer){const ie=be(S);z&&ve(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ie,t.DEPTH24_STENCIL8,S.width,S.height):ve(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ie,t.DEPTH24_STENCIL8,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,t.DEPTH_STENCIL,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.RENDERBUFFER,A)}else{const ie=S.isWebGLMultipleRenderTargets===!0?S.texture:[S.texture];for(let ee=0;ee<ie.length;ee++){const re=ie[ee],xe=s.convert(re.format,re.colorSpace),fe=s.convert(re.type),_e=y(re.internalFormat,xe,fe,re.colorSpace),Ae=be(S);z&&ve(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ae,_e,S.width,S.height):ve(S)?l.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ae,_e,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,_e,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Ce(A,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,A),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),W(S.depthTexture,0);const ie=i.get(S.depthTexture).__webglTexture,ee=be(S);if(S.depthTexture.format===fr)ve(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0);else if(S.depthTexture.format===Ts)ve(S)?l.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0,ee):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function we(A){const S=i.get(A),z=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!S.__autoAllocateDepthBuffer){if(z)throw new Error("target.depthTexture not supported in Cube render targets");Ce(S.__webglFramebuffer,A)}else if(z){S.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[ie]),S.__webglDepthbuffer[ie]=t.createRenderbuffer(),Re(S.__webglDepthbuffer[ie],A,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer=t.createRenderbuffer(),Re(S.__webglDepthbuffer,A,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ge(A,S,z){const ie=i.get(A);S!==void 0&&de(ie.__webglFramebuffer,A,A.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),z!==void 0&&we(A)}function H(A){const S=A.texture,z=i.get(A),ie=i.get(S);A.addEventListener("dispose",N),A.isWebGLMultipleRenderTargets!==!0&&(ie.__webglTexture===void 0&&(ie.__webglTexture=t.createTexture()),ie.__version=S.version,o.memory.textures++);const ee=A.isWebGLCubeRenderTarget===!0,re=A.isWebGLMultipleRenderTargets===!0,xe=p(A)||a;if(ee){z.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(a&&S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[fe]=[];for(let _e=0;_e<S.mipmaps.length;_e++)z.__webglFramebuffer[fe][_e]=t.createFramebuffer()}else z.__webglFramebuffer[fe]=t.createFramebuffer()}else{if(a&&S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let fe=0;fe<S.mipmaps.length;fe++)z.__webglFramebuffer[fe]=t.createFramebuffer()}else z.__webglFramebuffer=t.createFramebuffer();if(re)if(r.drawBuffers){const fe=A.texture;for(let _e=0,Ae=fe.length;_e<Ae;_e++){const Fe=i.get(fe[_e]);Fe.__webglTexture===void 0&&(Fe.__webglTexture=t.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&A.samples>0&&ve(A)===!1){const fe=re?S:[S];z.__webglMultisampledFramebuffer=t.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let _e=0;_e<fe.length;_e++){const Ae=fe[_e];z.__webglColorRenderbuffer[_e]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,z.__webglColorRenderbuffer[_e]);const Fe=s.convert(Ae.format,Ae.colorSpace),J=s.convert(Ae.type),Ze=y(Ae.internalFormat,Fe,J,Ae.colorSpace,A.isXRRenderTarget===!0),Be=be(A);t.renderbufferStorageMultisample(t.RENDERBUFFER,Be,Ze,A.width,A.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,z.__webglColorRenderbuffer[_e])}t.bindRenderbuffer(t.RENDERBUFFER,null),A.depthBuffer&&(z.__webglDepthRenderbuffer=t.createRenderbuffer(),Re(z.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ee){n.bindTexture(t.TEXTURE_CUBE_MAP,ie.__webglTexture),j(t.TEXTURE_CUBE_MAP,S,xe);for(let fe=0;fe<6;fe++)if(a&&S.mipmaps&&S.mipmaps.length>0)for(let _e=0;_e<S.mipmaps.length;_e++)de(z.__webglFramebuffer[fe][_e],A,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,_e);else de(z.__webglFramebuffer[fe],A,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);_(S,xe)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(re){const fe=A.texture;for(let _e=0,Ae=fe.length;_e<Ae;_e++){const Fe=fe[_e],J=i.get(Fe);n.bindTexture(t.TEXTURE_2D,J.__webglTexture),j(t.TEXTURE_2D,Fe,xe),de(z.__webglFramebuffer,A,Fe,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,0),_(Fe,xe)&&g(t.TEXTURE_2D)}n.unbindTexture()}else{let fe=t.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(a?fe=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),n.bindTexture(fe,ie.__webglTexture),j(fe,S,xe),a&&S.mipmaps&&S.mipmaps.length>0)for(let _e=0;_e<S.mipmaps.length;_e++)de(z.__webglFramebuffer[_e],A,S,t.COLOR_ATTACHMENT0,fe,_e);else de(z.__webglFramebuffer,A,S,t.COLOR_ATTACHMENT0,fe,0);_(S,xe)&&g(fe),n.unbindTexture()}A.depthBuffer&&we(A)}function Pt(A){const S=p(A)||a,z=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let ie=0,ee=z.length;ie<ee;ie++){const re=z[ie];if(_(re,S)){const xe=A.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,fe=i.get(re).__webglTexture;n.bindTexture(xe,fe),g(xe),n.unbindTexture()}}}function Ee(A){if(a&&A.samples>0&&ve(A)===!1){const S=A.isWebGLMultipleRenderTargets?A.texture:[A.texture],z=A.width,ie=A.height;let ee=t.COLOR_BUFFER_BIT;const re=[],xe=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,fe=i.get(A),_e=A.isWebGLMultipleRenderTargets===!0;if(_e)for(let Ae=0;Ae<S.length;Ae++)n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,fe.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,fe.__webglFramebuffer);for(let Ae=0;Ae<S.length;Ae++){re.push(t.COLOR_ATTACHMENT0+Ae),A.depthBuffer&&re.push(xe);const Fe=fe.__ignoreDepthValues!==void 0?fe.__ignoreDepthValues:!1;if(Fe===!1&&(A.depthBuffer&&(ee|=t.DEPTH_BUFFER_BIT),A.stencilBuffer&&(ee|=t.STENCIL_BUFFER_BIT)),_e&&t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,fe.__webglColorRenderbuffer[Ae]),Fe===!0&&(t.invalidateFramebuffer(t.READ_FRAMEBUFFER,[xe]),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[xe])),_e){const J=i.get(S[Ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,J,0)}t.blitFramebuffer(0,0,z,ie,0,0,z,ie,ee,t.NEAREST),u&&t.invalidateFramebuffer(t.READ_FRAMEBUFFER,re)}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),_e)for(let Ae=0;Ae<S.length;Ae++){n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,fe.__webglColorRenderbuffer[Ae]);const Fe=i.get(S[Ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,fe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,Fe,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,fe.__webglMultisampledFramebuffer)}}function be(A){return Math.min(r.maxSamples,A.samples)}function ve(A){const S=i.get(A);return a&&A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function tt(A){const S=o.render.frame;f.get(A)!==S&&(f.set(A,S),A.update())}function Oe(A,S){const z=A.colorSpace,ie=A.format,ee=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||A.format===Gc||z!==hi&&z!==Sn&&(Je.getTransfer(z)===it?a===!1?e.has("EXT_sRGB")===!0&&ie===On?(A.format=Gc,A.minFilter=yn,A.generateMipmaps=!1):S=__.sRGBToLinear(S):(ie!==On||ee!==Hi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",z)),S}this.allocateTextureUnit=b,this.resetTextureUnits=Q,this.setTexture2D=W,this.setTexture2DArray=$,this.setTexture3D=D,this.setTextureCube=O,this.rebindTextures=Ge,this.setupRenderTarget=H,this.updateRenderTargetMipmap=Pt,this.updateMultisampleRenderTarget=Ee,this.setupDepthRenderbuffer=we,this.setupFrameBufferTexture=de,this.useMultisampledRTT=ve}function P1(t,e,n){const i=n.isWebGL2;function r(s,o=Sn){let a;const l=Je.getTransfer(o);if(s===Hi)return t.UNSIGNED_BYTE;if(s===a_)return t.UNSIGNED_SHORT_4_4_4_4;if(s===l_)return t.UNSIGNED_SHORT_5_5_5_1;if(s===Zx)return t.BYTE;if(s===Qx)return t.SHORT;if(s===Gf)return t.UNSIGNED_SHORT;if(s===o_)return t.INT;if(s===Pi)return t.UNSIGNED_INT;if(s===Li)return t.FLOAT;if(s===Ro)return i?t.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Jx)return t.ALPHA;if(s===On)return t.RGBA;if(s===ey)return t.LUMINANCE;if(s===ty)return t.LUMINANCE_ALPHA;if(s===fr)return t.DEPTH_COMPONENT;if(s===Ts)return t.DEPTH_STENCIL;if(s===Gc)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===ny)return t.RED;if(s===u_)return t.RED_INTEGER;if(s===iy)return t.RG;if(s===c_)return t.RG_INTEGER;if(s===f_)return t.RGBA_INTEGER;if(s===hu||s===pu||s===mu||s===gu)if(l===it)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===hu)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===pu)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===mu)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===gu)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===hu)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===pu)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===mu)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===gu)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Sh||s===Mh||s===Eh||s===Th)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Sh)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Mh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Eh)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Th)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===d_)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===wh||s===Ah)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===wh)return l===it?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Ah)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Rh||s===Ch||s===Ph||s===Lh||s===bh||s===Dh||s===Uh||s===Nh||s===Ih||s===Oh||s===Fh||s===zh||s===kh||s===Bh)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===Rh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Ch)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Ph)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Lh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===bh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Dh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Uh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Nh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Ih)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Oh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Fh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===zh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===kh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Bh)return l===it?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===_u||s===Hh||s===Gh)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===_u)return l===it?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Hh)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Gh)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===ry||s===Vh||s===Wh||s===Xh)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===_u)return a.COMPRESSED_RED_RGTC1_EXT;if(s===Vh)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Wh)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Xh)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===cr?i?t.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):t[s]!==void 0?t[s]:null}return{convert:r}}class L1 extends cn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ss extends Gt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const b1={type:"move"};class Bu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ss,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ss,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new U,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new U),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ss,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new U,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new U),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const x of e.hand.values()){const p=n.getJointPose(x,i),c=this._getHandJoint(u,x);p!==null&&(c.matrix.fromArray(p.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=p.radius),c.visible=p!==null}const f=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],h=f.position.distanceTo(d.position),m=.02,v=.005;u.inputState.pinching&&h>m+v?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&h<=m-v&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(b1)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new ss;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}class D1 extends Tr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,f=null,d=null,h=null,m=null,v=null;const x=n.getContextAttributes();let p=null,c=null;const _=[],g=[],y=new Ne;let C=null;const R=new cn;R.layers.enable(1),R.viewport=new ot;const w=new cn;w.layers.enable(2),w.viewport=new ot;const N=[R,w],M=new L1;M.layers.enable(1),M.layers.enable(2);let E=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let Z=_[j];return Z===void 0&&(Z=new Bu,_[j]=Z),Z.getTargetRaySpace()},this.getControllerGrip=function(j){let Z=_[j];return Z===void 0&&(Z=new Bu,_[j]=Z),Z.getGripSpace()},this.getHand=function(j){let Z=_[j];return Z===void 0&&(Z=new Bu,_[j]=Z),Z.getHandSpace()};function X(j){const Z=g.indexOf(j.inputSource);if(Z===-1)return;const ue=_[Z];ue!==void 0&&(ue.update(j.inputSource,j.frame,u||o),ue.dispatchEvent({type:j.type,data:j.inputSource}))}function Q(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",Q),r.removeEventListener("inputsourceschange",b);for(let j=0;j<_.length;j++){const Z=g[j];Z!==null&&(g[j]=null,_[j].disconnect(Z))}E=null,B=null,e.setRenderTarget(p),m=null,h=null,d=null,r=null,c=null,K.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(y.width,y.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){a=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(j){u=j},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return d},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",Q),r.addEventListener("inputsourceschange",b),x.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(y),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const Z={antialias:r.renderState.layers===void 0?x.antialias:!0,alpha:!0,depth:x.depth,stencil:x.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,Z),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),c=new vr(m.framebufferWidth,m.framebufferHeight,{format:On,type:Hi,colorSpace:e.outputColorSpace,stencilBuffer:x.stencil})}else{let Z=null,ue=null,ae=null;x.depth&&(ae=x.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Z=x.stencil?Ts:fr,ue=x.stencil?cr:Pi);const de={colorFormat:n.RGBA8,depthFormat:ae,scaleFactor:s};d=new XRWebGLBinding(r,n),h=d.createProjectionLayer(de),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),c=new vr(h.textureWidth,h.textureHeight,{format:On,type:Hi,depthTexture:new b_(h.textureWidth,h.textureHeight,ue,void 0,void 0,void 0,void 0,void 0,void 0,Z),stencilBuffer:x.stencil,colorSpace:e.outputColorSpace,samples:x.antialias?4:0});const Re=e.properties.get(c);Re.__ignoreDepthValues=h.ignoreDepthValues}c.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),K.setContext(r),K.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function b(j){for(let Z=0;Z<j.removed.length;Z++){const ue=j.removed[Z],ae=g.indexOf(ue);ae>=0&&(g[ae]=null,_[ae].disconnect(ue))}for(let Z=0;Z<j.added.length;Z++){const ue=j.added[Z];let ae=g.indexOf(ue);if(ae===-1){for(let Re=0;Re<_.length;Re++)if(Re>=g.length){g.push(ue),ae=Re;break}else if(g[Re]===null){g[Re]=ue,ae=Re;break}if(ae===-1)break}const de=_[ae];de&&de.connect(ue)}}const k=new U,W=new U;function $(j,Z,ue){k.setFromMatrixPosition(Z.matrixWorld),W.setFromMatrixPosition(ue.matrixWorld);const ae=k.distanceTo(W),de=Z.projectionMatrix.elements,Re=ue.projectionMatrix.elements,Ce=de[14]/(de[10]-1),we=de[14]/(de[10]+1),Ge=(de[9]+1)/de[5],H=(de[9]-1)/de[5],Pt=(de[8]-1)/de[0],Ee=(Re[8]+1)/Re[0],be=Ce*Pt,ve=Ce*Ee,tt=ae/(-Pt+Ee),Oe=tt*-Pt;Z.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(Oe),j.translateZ(tt),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert();const A=Ce+tt,S=we+tt,z=be-Oe,ie=ve+(ae-Oe),ee=Ge*we/S*A,re=H*we/S*A;j.projectionMatrix.makePerspective(z,ie,ee,re,A,S),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}function D(j,Z){Z===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(Z.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;M.near=w.near=R.near=j.near,M.far=w.far=R.far=j.far,(E!==M.near||B!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),E=M.near,B=M.far);const Z=j.parent,ue=M.cameras;D(M,Z);for(let ae=0;ae<ue.length;ae++)D(ue[ae],Z);ue.length===2?$(M,R,w):M.projectionMatrix.copy(R.projectionMatrix),O(j,M,Z)};function O(j,Z,ue){ue===null?j.matrix.copy(Z.matrixWorld):(j.matrix.copy(ue.matrixWorld),j.matrix.invert(),j.matrix.multiply(Z.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(Z.projectionMatrix),j.projectionMatrixInverse.copy(Z.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=Co*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(j){l=j,h!==null&&(h.fixedFoveation=j),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=j)};let F=null;function q(j,Z){if(f=Z.getViewerPose(u||o),v=Z,f!==null){const ue=f.views;m!==null&&(e.setRenderTargetFramebuffer(c,m.framebuffer),e.setRenderTarget(c));let ae=!1;ue.length!==M.cameras.length&&(M.cameras.length=0,ae=!0);for(let de=0;de<ue.length;de++){const Re=ue[de];let Ce=null;if(m!==null)Ce=m.getViewport(Re);else{const Ge=d.getViewSubImage(h,Re);Ce=Ge.viewport,de===0&&(e.setRenderTargetTextures(c,Ge.colorTexture,h.ignoreDepthValues?void 0:Ge.depthStencilTexture),e.setRenderTarget(c))}let we=N[de];we===void 0&&(we=new cn,we.layers.enable(de),we.viewport=new ot,N[de]=we),we.matrix.fromArray(Re.transform.matrix),we.matrix.decompose(we.position,we.quaternion,we.scale),we.projectionMatrix.fromArray(Re.projectionMatrix),we.projectionMatrixInverse.copy(we.projectionMatrix).invert(),we.viewport.set(Ce.x,Ce.y,Ce.width,Ce.height),de===0&&(M.matrix.copy(we.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),ae===!0&&M.cameras.push(we)}}for(let ue=0;ue<_.length;ue++){const ae=g[ue],de=_[ue];ae!==null&&de!==void 0&&de.update(ae,Z,u||o)}F&&F(j,Z),Z.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Z}),v=null}const K=new P_;K.setAnimationLoop(q),this.setAnimationLoop=function(j){F=j},this.dispose=function(){}}}function U1(t,e){function n(p,c){p.matrixAutoUpdate===!0&&p.updateMatrix(),c.value.copy(p.matrix)}function i(p,c){c.color.getRGB(p.fogColor.value,A_(t)),c.isFog?(p.fogNear.value=c.near,p.fogFar.value=c.far):c.isFogExp2&&(p.fogDensity.value=c.density)}function r(p,c,_,g,y){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(p,c):c.isMeshToonMaterial?(s(p,c),d(p,c)):c.isMeshPhongMaterial?(s(p,c),f(p,c)):c.isMeshStandardMaterial?(s(p,c),h(p,c),c.isMeshPhysicalMaterial&&m(p,c,y)):c.isMeshMatcapMaterial?(s(p,c),v(p,c)):c.isMeshDepthMaterial?s(p,c):c.isMeshDistanceMaterial?(s(p,c),x(p,c)):c.isMeshNormalMaterial?s(p,c):c.isLineBasicMaterial?(o(p,c),c.isLineDashedMaterial&&a(p,c)):c.isPointsMaterial?l(p,c,_,g):c.isSpriteMaterial?u(p,c):c.isShadowMaterial?(p.color.value.copy(c.color),p.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(p,c){p.opacity.value=c.opacity,c.color&&p.diffuse.value.copy(c.color),c.emissive&&p.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.bumpMap&&(p.bumpMap.value=c.bumpMap,n(c.bumpMap,p.bumpMapTransform),p.bumpScale.value=c.bumpScale,c.side===rn&&(p.bumpScale.value*=-1)),c.normalMap&&(p.normalMap.value=c.normalMap,n(c.normalMap,p.normalMapTransform),p.normalScale.value.copy(c.normalScale),c.side===rn&&p.normalScale.value.negate()),c.displacementMap&&(p.displacementMap.value=c.displacementMap,n(c.displacementMap,p.displacementMapTransform),p.displacementScale.value=c.displacementScale,p.displacementBias.value=c.displacementBias),c.emissiveMap&&(p.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,p.emissiveMapTransform)),c.specularMap&&(p.specularMap.value=c.specularMap,n(c.specularMap,p.specularMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest);const _=e.get(c).envMap;if(_&&(p.envMap.value=_,p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=c.reflectivity,p.ior.value=c.ior,p.refractionRatio.value=c.refractionRatio),c.lightMap){p.lightMap.value=c.lightMap;const g=t._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=c.lightMapIntensity*g,n(c.lightMap,p.lightMapTransform)}c.aoMap&&(p.aoMap.value=c.aoMap,p.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,p.aoMapTransform))}function o(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform))}function a(p,c){p.dashSize.value=c.dashSize,p.totalSize.value=c.dashSize+c.gapSize,p.scale.value=c.scale}function l(p,c,_,g){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.size.value=c.size*_,p.scale.value=g*.5,c.map&&(p.map.value=c.map,n(c.map,p.uvTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function u(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.rotation.value=c.rotation,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function f(p,c){p.specular.value.copy(c.specular),p.shininess.value=Math.max(c.shininess,1e-4)}function d(p,c){c.gradientMap&&(p.gradientMap.value=c.gradientMap)}function h(p,c){p.metalness.value=c.metalness,c.metalnessMap&&(p.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,p.metalnessMapTransform)),p.roughness.value=c.roughness,c.roughnessMap&&(p.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,p.roughnessMapTransform)),e.get(c).envMap&&(p.envMapIntensity.value=c.envMapIntensity)}function m(p,c,_){p.ior.value=c.ior,c.sheen>0&&(p.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),p.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(p.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,p.sheenColorMapTransform)),c.sheenRoughnessMap&&(p.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,p.sheenRoughnessMapTransform))),c.clearcoat>0&&(p.clearcoat.value=c.clearcoat,p.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(p.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,p.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(p.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===rn&&p.clearcoatNormalScale.value.negate())),c.iridescence>0&&(p.iridescence.value=c.iridescence,p.iridescenceIOR.value=c.iridescenceIOR,p.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(p.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,p.iridescenceMapTransform)),c.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),c.transmission>0&&(p.transmission.value=c.transmission,p.transmissionSamplerMap.value=_.texture,p.transmissionSamplerSize.value.set(_.width,_.height),c.transmissionMap&&(p.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,p.transmissionMapTransform)),p.thickness.value=c.thickness,c.thicknessMap&&(p.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=c.attenuationDistance,p.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(p.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(p.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=c.specularIntensity,p.specularColor.value.copy(c.specularColor),c.specularColorMap&&(p.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,p.specularColorMapTransform)),c.specularIntensityMap&&(p.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,c){c.matcap&&(p.matcap.value=c.matcap)}function x(p,c){const _=e.get(c).light;p.referencePosition.value.setFromMatrixPosition(_.matrixWorld),p.nearDistance.value=_.shadow.camera.near,p.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function N1(t,e,n,i){let r={},s={},o=[];const a=n.isWebGL2?t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(_,g){const y=g.program;i.uniformBlockBinding(_,y)}function u(_,g){let y=r[_.id];y===void 0&&(v(_),y=f(_),r[_.id]=y,_.addEventListener("dispose",p));const C=g.program;i.updateUBOMapping(_,C);const R=e.render.frame;s[_.id]!==R&&(h(_),s[_.id]=R)}function f(_){const g=d();_.__bindingPointIndex=g;const y=t.createBuffer(),C=_.__size,R=_.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,C,R),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,g,y),y}function d(){for(let _=0;_<a;_++)if(o.indexOf(_)===-1)return o.push(_),_;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(_){const g=r[_.id],y=_.uniforms,C=_.__cache;t.bindBuffer(t.UNIFORM_BUFFER,g);for(let R=0,w=y.length;R<w;R++){const N=Array.isArray(y[R])?y[R]:[y[R]];for(let M=0,E=N.length;M<E;M++){const B=N[M];if(m(B,R,M,C)===!0){const X=B.__offset,Q=Array.isArray(B.value)?B.value:[B.value];let b=0;for(let k=0;k<Q.length;k++){const W=Q[k],$=x(W);typeof W=="number"||typeof W=="boolean"?(B.__data[0]=W,t.bufferSubData(t.UNIFORM_BUFFER,X+b,B.__data)):W.isMatrix3?(B.__data[0]=W.elements[0],B.__data[1]=W.elements[1],B.__data[2]=W.elements[2],B.__data[3]=0,B.__data[4]=W.elements[3],B.__data[5]=W.elements[4],B.__data[6]=W.elements[5],B.__data[7]=0,B.__data[8]=W.elements[6],B.__data[9]=W.elements[7],B.__data[10]=W.elements[8],B.__data[11]=0):(W.toArray(B.__data,b),b+=$.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,X,B.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(_,g,y,C){const R=_.value,w=g+"_"+y;if(C[w]===void 0)return typeof R=="number"||typeof R=="boolean"?C[w]=R:C[w]=R.clone(),!0;{const N=C[w];if(typeof R=="number"||typeof R=="boolean"){if(N!==R)return C[w]=R,!0}else if(N.equals(R)===!1)return N.copy(R),!0}return!1}function v(_){const g=_.uniforms;let y=0;const C=16;for(let w=0,N=g.length;w<N;w++){const M=Array.isArray(g[w])?g[w]:[g[w]];for(let E=0,B=M.length;E<B;E++){const X=M[E],Q=Array.isArray(X.value)?X.value:[X.value];for(let b=0,k=Q.length;b<k;b++){const W=Q[b],$=x(W),D=y%C;D!==0&&C-D<$.boundary&&(y+=C-D),X.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=y,y+=$.storage}}}const R=y%C;return R>0&&(y+=C-R),_.__size=y,_.__cache={},this}function x(_){const g={boundary:0,storage:0};return typeof _=="number"||typeof _=="boolean"?(g.boundary=4,g.storage=4):_.isVector2?(g.boundary=8,g.storage=8):_.isVector3||_.isColor?(g.boundary=16,g.storage=12):_.isVector4?(g.boundary=16,g.storage=16):_.isMatrix3?(g.boundary=48,g.storage=48):_.isMatrix4?(g.boundary=64,g.storage=64):_.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",_),g}function p(_){const g=_.target;g.removeEventListener("dispose",p);const y=o.indexOf(g.__bindingPointIndex);o.splice(y,1),t.deleteBuffer(r[g.id]),delete r[g.id],delete s[g.id]}function c(){for(const _ in r)t.deleteBuffer(r[_]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class F_{constructor(e={}){const{canvas:n=Ly(),context:i=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let h;i!==null?h=i.getContextAttributes().alpha:h=o;const m=new Uint32Array(4),v=new Int32Array(4);let x=null,p=null;const c=[],_=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Dt,this._useLegacyLights=!1,this.toneMapping=Bi,this.toneMappingExposure=1;const g=this;let y=!1,C=0,R=0,w=null,N=-1,M=null;const E=new ot,B=new ot;let X=null;const Q=new Ke(0);let b=0,k=n.width,W=n.height,$=1,D=null,O=null;const F=new ot(0,0,k,W),q=new ot(0,0,k,W);let K=!1;const j=new jf;let Z=!1,ue=!1,ae=null;const de=new yt,Re=new Ne,Ce=new U,we={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Ge(){return w===null?$:1}let H=i;function Pt(T,I){for(let V=0;V<T.length;V++){const Y=T[V],G=n.getContext(Y,I);if(G!==null)return G}return null}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Hf}`),n.addEventListener("webglcontextlost",te,!1),n.addEventListener("webglcontextrestored",L,!1),n.addEventListener("webglcontextcreationerror",oe,!1),H===null){const I=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&I.shift(),H=Pt(I,T),H===null)throw Pt(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&H instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),H.getShaderPrecisionFormat===void 0&&(H.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let Ee,be,ve,tt,Oe,A,S,z,ie,ee,re,xe,fe,_e,Ae,Fe,J,Ze,Be,De,Me,he,P,se;function ye(){Ee=new WE(H),be=new zE(H,Ee,e),Ee.init(be),he=new P1(H,Ee,be),ve=new R1(H,Ee,be),tt=new YE(H),Oe=new h1,A=new C1(H,Ee,ve,Oe,be,he,tt),S=new BE(g),z=new VE(g),ie=new tS(H,be),P=new OE(H,Ee,ie,be),ee=new XE(H,ie,tt,P),re=new ZE(H,ee,ie,tt),Be=new KE(H,be,A),Fe=new kE(Oe),xe=new d1(g,S,z,Ee,be,P,Fe),fe=new U1(g,Oe),_e=new m1,Ae=new S1(Ee,be),Ze=new IE(g,S,z,ve,re,h,l),J=new A1(g,re,be),se=new N1(H,tt,be,ve),De=new FE(H,Ee,tt,be),Me=new jE(H,Ee,tt,be),tt.programs=xe.programs,g.capabilities=be,g.extensions=Ee,g.properties=Oe,g.renderLists=_e,g.shadowMap=J,g.state=ve,g.info=tt}ye();const ge=new D1(g,H);this.xr=ge,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const T=Ee.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=Ee.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(T){T!==void 0&&($=T,this.setSize(k,W,!1))},this.getSize=function(T){return T.set(k,W)},this.setSize=function(T,I,V=!0){if(ge.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}k=T,W=I,n.width=Math.floor(T*$),n.height=Math.floor(I*$),V===!0&&(n.style.width=T+"px",n.style.height=I+"px"),this.setViewport(0,0,T,I)},this.getDrawingBufferSize=function(T){return T.set(k*$,W*$).floor()},this.setDrawingBufferSize=function(T,I,V){k=T,W=I,$=V,n.width=Math.floor(T*V),n.height=Math.floor(I*V),this.setViewport(0,0,T,I)},this.getCurrentViewport=function(T){return T.copy(E)},this.getViewport=function(T){return T.copy(F)},this.setViewport=function(T,I,V,Y){T.isVector4?F.set(T.x,T.y,T.z,T.w):F.set(T,I,V,Y),ve.viewport(E.copy(F).multiplyScalar($).floor())},this.getScissor=function(T){return T.copy(q)},this.setScissor=function(T,I,V,Y){T.isVector4?q.set(T.x,T.y,T.z,T.w):q.set(T,I,V,Y),ve.scissor(B.copy(q).multiplyScalar($).floor())},this.getScissorTest=function(){return K},this.setScissorTest=function(T){ve.setScissorTest(K=T)},this.setOpaqueSort=function(T){D=T},this.setTransparentSort=function(T){O=T},this.getClearColor=function(T){return T.copy(Ze.getClearColor())},this.setClearColor=function(){Ze.setClearColor.apply(Ze,arguments)},this.getClearAlpha=function(){return Ze.getClearAlpha()},this.setClearAlpha=function(){Ze.setClearAlpha.apply(Ze,arguments)},this.clear=function(T=!0,I=!0,V=!0){let Y=0;if(T){let G=!1;if(w!==null){const pe=w.texture.format;G=pe===f_||pe===c_||pe===u_}if(G){const pe=w.texture.type,Se=pe===Hi||pe===Pi||pe===Gf||pe===cr||pe===a_||pe===l_,Le=Ze.getClearColor(),Ue=Ze.getClearAlpha(),He=Le.r,Ie=Le.g,ze=Le.b;Se?(m[0]=He,m[1]=Ie,m[2]=ze,m[3]=Ue,H.clearBufferuiv(H.COLOR,0,m)):(v[0]=He,v[1]=Ie,v[2]=ze,v[3]=Ue,H.clearBufferiv(H.COLOR,0,v))}else Y|=H.COLOR_BUFFER_BIT}I&&(Y|=H.DEPTH_BUFFER_BIT),V&&(Y|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(Y)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",te,!1),n.removeEventListener("webglcontextrestored",L,!1),n.removeEventListener("webglcontextcreationerror",oe,!1),_e.dispose(),Ae.dispose(),Oe.dispose(),S.dispose(),z.dispose(),re.dispose(),P.dispose(),se.dispose(),xe.dispose(),ge.dispose(),ge.removeEventListener("sessionstart",pt),ge.removeEventListener("sessionend",$e),ae&&(ae.dispose(),ae=null),_t.stop()};function te(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),y=!0}function L(){console.log("THREE.WebGLRenderer: Context Restored."),y=!1;const T=tt.autoReset,I=J.enabled,V=J.autoUpdate,Y=J.needsUpdate,G=J.type;ye(),tt.autoReset=T,J.enabled=I,J.autoUpdate=V,J.needsUpdate=Y,J.type=G}function oe(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function ce(T){const I=T.target;I.removeEventListener("dispose",ce),Pe(I)}function Pe(T){Te(T),Oe.remove(T)}function Te(T){const I=Oe.get(T).programs;I!==void 0&&(I.forEach(function(V){xe.releaseProgram(V)}),T.isShaderMaterial&&xe.releaseShaderCache(T))}this.renderBufferDirect=function(T,I,V,Y,G,pe){I===null&&(I=we);const Se=G.isMesh&&G.matrixWorld.determinant()<0,Le=B_(T,I,V,Y,G);ve.setMaterial(Y,Se);let Ue=V.index,He=1;if(Y.wireframe===!0){if(Ue=ee.getWireframeAttribute(V),Ue===void 0)return;He=2}const Ie=V.drawRange,ze=V.attributes.position;let mt=Ie.start*He,on=(Ie.start+Ie.count)*He;pe!==null&&(mt=Math.max(mt,pe.start*He),on=Math.min(on,(pe.start+pe.count)*He)),Ue!==null?(mt=Math.max(mt,0),on=Math.min(on,Ue.count)):ze!=null&&(mt=Math.max(mt,0),on=Math.min(on,ze.count));const wt=on-mt;if(wt<0||wt===1/0)return;P.setup(G,Y,Le,V,Ue);let $n,at=De;if(Ue!==null&&($n=ie.get(Ue),at=Me,at.setIndex($n)),G.isMesh)Y.wireframe===!0?(ve.setLineWidth(Y.wireframeLinewidth*Ge()),at.setMode(H.LINES)):at.setMode(H.TRIANGLES);else if(G.isLine){let Ve=Y.linewidth;Ve===void 0&&(Ve=1),ve.setLineWidth(Ve*Ge()),G.isLineSegments?at.setMode(H.LINES):G.isLineLoop?at.setMode(H.LINE_LOOP):at.setMode(H.LINE_STRIP)}else G.isPoints?at.setMode(H.POINTS):G.isSprite&&at.setMode(H.TRIANGLES);if(G.isBatchedMesh)at.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else if(G.isInstancedMesh)at.renderInstances(mt,wt,G.count);else if(V.isInstancedBufferGeometry){const Ve=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,Ol=Math.min(V.instanceCount,Ve);at.renderInstances(mt,wt,Ol)}else at.render(mt,wt)};function Xe(T,I,V){T.transparent===!0&&T.side===ri&&T.forceSinglePass===!1?(T.side=rn,T.needsUpdate=!0,ko(T,I,V),T.side=Wi,T.needsUpdate=!0,ko(T,I,V),T.side=ri):ko(T,I,V)}this.compile=function(T,I,V=null){V===null&&(V=T),p=Ae.get(V),p.init(),_.push(p),V.traverseVisible(function(G){G.isLight&&G.layers.test(I.layers)&&(p.pushLight(G),G.castShadow&&p.pushShadow(G))}),T!==V&&T.traverseVisible(function(G){G.isLight&&G.layers.test(I.layers)&&(p.pushLight(G),G.castShadow&&p.pushShadow(G))}),p.setupLights(g._useLegacyLights);const Y=new Set;return T.traverse(function(G){const pe=G.material;if(pe)if(Array.isArray(pe))for(let Se=0;Se<pe.length;Se++){const Le=pe[Se];Xe(Le,V,G),Y.add(Le)}else Xe(pe,V,G),Y.add(pe)}),_.pop(),p=null,Y},this.compileAsync=function(T,I,V=null){const Y=this.compile(T,I,V);return new Promise(G=>{function pe(){if(Y.forEach(function(Se){Oe.get(Se).currentProgram.isReady()&&Y.delete(Se)}),Y.size===0){G(T);return}setTimeout(pe,10)}Ee.get("KHR_parallel_shader_compile")!==null?pe():setTimeout(pe,10)})};let je=null;function ft(T){je&&je(T)}function pt(){_t.stop()}function $e(){_t.start()}const _t=new P_;_t.setAnimationLoop(ft),typeof self<"u"&&_t.setContext(self),this.setAnimationLoop=function(T){je=T,ge.setAnimationLoop(T),T===null?_t.stop():_t.start()},ge.addEventListener("sessionstart",pt),ge.addEventListener("sessionend",$e),this.render=function(T,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),ge.enabled===!0&&ge.isPresenting===!0&&(ge.cameraAutoUpdate===!0&&ge.updateCamera(I),I=ge.getCamera()),T.isScene===!0&&T.onBeforeRender(g,T,I,w),p=Ae.get(T,_.length),p.init(),_.push(p),de.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),j.setFromProjectionMatrix(de),ue=this.localClippingEnabled,Z=Fe.init(this.clippingPlanes,ue),x=_e.get(T,c.length),x.init(),c.push(x),Bn(T,I,0,g.sortObjects),x.finish(),g.sortObjects===!0&&x.sort(D,O),this.info.render.frame++,Z===!0&&Fe.beginShadows();const V=p.state.shadowsArray;if(J.render(V,T,I),Z===!0&&Fe.endShadows(),this.info.autoReset===!0&&this.info.reset(),Ze.render(x,T),p.setupLights(g._useLegacyLights),I.isArrayCamera){const Y=I.cameras;for(let G=0,pe=Y.length;G<pe;G++){const Se=Y[G];Jf(x,T,Se,Se.viewport)}}else Jf(x,T,I);w!==null&&(A.updateMultisampleRenderTarget(w),A.updateRenderTargetMipmap(w)),T.isScene===!0&&T.onAfterRender(g,T,I),P.resetDefaultState(),N=-1,M=null,_.pop(),_.length>0?p=_[_.length-1]:p=null,c.pop(),c.length>0?x=c[c.length-1]:x=null};function Bn(T,I,V,Y){if(T.visible===!1)return;if(T.layers.test(I.layers)){if(T.isGroup)V=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(I);else if(T.isLight)p.pushLight(T),T.castShadow&&p.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||j.intersectsSprite(T)){Y&&Ce.setFromMatrixPosition(T.matrixWorld).applyMatrix4(de);const Se=re.update(T),Le=T.material;Le.visible&&x.push(T,Se,Le,V,Ce.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||j.intersectsObject(T))){const Se=re.update(T),Le=T.material;if(Y&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Ce.copy(T.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Ce.copy(Se.boundingSphere.center)),Ce.applyMatrix4(T.matrixWorld).applyMatrix4(de)),Array.isArray(Le)){const Ue=Se.groups;for(let He=0,Ie=Ue.length;He<Ie;He++){const ze=Ue[He],mt=Le[ze.materialIndex];mt&&mt.visible&&x.push(T,Se,mt,V,Ce.z,ze)}}else Le.visible&&x.push(T,Se,Le,V,Ce.z,null)}}const pe=T.children;for(let Se=0,Le=pe.length;Se<Le;Se++)Bn(pe[Se],I,V,Y)}function Jf(T,I,V,Y){const G=T.opaque,pe=T.transmissive,Se=T.transparent;p.setupLightsView(V),Z===!0&&Fe.setGlobalState(g.clippingPlanes,V),pe.length>0&&k_(G,pe,I,V),Y&&ve.viewport(E.copy(Y)),G.length>0&&zo(G,I,V),pe.length>0&&zo(pe,I,V),Se.length>0&&zo(Se,I,V),ve.buffers.depth.setTest(!0),ve.buffers.depth.setMask(!0),ve.buffers.color.setMask(!0),ve.setPolygonOffset(!1)}function k_(T,I,V,Y){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;const pe=be.isWebGL2;ae===null&&(ae=new vr(1,1,{generateMipmaps:!0,type:Ee.has("EXT_color_buffer_half_float")?Ro:Hi,minFilter:Ao,samples:pe?4:0})),g.getDrawingBufferSize(Re),pe?ae.setSize(Re.x,Re.y):ae.setSize(ml(Re.x),ml(Re.y));const Se=g.getRenderTarget();g.setRenderTarget(ae),g.getClearColor(Q),b=g.getClearAlpha(),b<1&&g.setClearColor(16777215,.5),g.clear();const Le=g.toneMapping;g.toneMapping=Bi,zo(T,V,Y),A.updateMultisampleRenderTarget(ae),A.updateRenderTargetMipmap(ae);let Ue=!1;for(let He=0,Ie=I.length;He<Ie;He++){const ze=I[He],mt=ze.object,on=ze.geometry,wt=ze.material,$n=ze.group;if(wt.side===ri&&mt.layers.test(Y.layers)){const at=wt.side;wt.side=rn,wt.needsUpdate=!0,ed(mt,V,Y,on,wt,$n),wt.side=at,wt.needsUpdate=!0,Ue=!0}}Ue===!0&&(A.updateMultisampleRenderTarget(ae),A.updateRenderTargetMipmap(ae)),g.setRenderTarget(Se),g.setClearColor(Q,b),g.toneMapping=Le}function zo(T,I,V){const Y=I.isScene===!0?I.overrideMaterial:null;for(let G=0,pe=T.length;G<pe;G++){const Se=T[G],Le=Se.object,Ue=Se.geometry,He=Y===null?Se.material:Y,Ie=Se.group;Le.layers.test(V.layers)&&ed(Le,I,V,Ue,He,Ie)}}function ed(T,I,V,Y,G,pe){T.onBeforeRender(g,I,V,Y,G,pe),T.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),G.onBeforeRender(g,I,V,Y,T,pe),G.transparent===!0&&G.side===ri&&G.forceSinglePass===!1?(G.side=rn,G.needsUpdate=!0,g.renderBufferDirect(V,I,Y,G,T,pe),G.side=Wi,G.needsUpdate=!0,g.renderBufferDirect(V,I,Y,G,T,pe),G.side=ri):g.renderBufferDirect(V,I,Y,G,T,pe),T.onAfterRender(g,I,V,Y,G,pe)}function ko(T,I,V){I.isScene!==!0&&(I=we);const Y=Oe.get(T),G=p.state.lights,pe=p.state.shadowsArray,Se=G.state.version,Le=xe.getParameters(T,G.state,pe,I,V),Ue=xe.getProgramCacheKey(Le);let He=Y.programs;Y.environment=T.isMeshStandardMaterial?I.environment:null,Y.fog=I.fog,Y.envMap=(T.isMeshStandardMaterial?z:S).get(T.envMap||Y.environment),He===void 0&&(T.addEventListener("dispose",ce),He=new Map,Y.programs=He);let Ie=He.get(Ue);if(Ie!==void 0){if(Y.currentProgram===Ie&&Y.lightsStateVersion===Se)return nd(T,Le),Ie}else Le.uniforms=xe.getUniforms(T),T.onBuild(V,Le,g),T.onBeforeCompile(Le,g),Ie=xe.acquireProgram(Le,Ue),He.set(Ue,Ie),Y.uniforms=Le.uniforms;const ze=Y.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(ze.clippingPlanes=Fe.uniform),nd(T,Le),Y.needsLights=G_(T),Y.lightsStateVersion=Se,Y.needsLights&&(ze.ambientLightColor.value=G.state.ambient,ze.lightProbe.value=G.state.probe,ze.directionalLights.value=G.state.directional,ze.directionalLightShadows.value=G.state.directionalShadow,ze.spotLights.value=G.state.spot,ze.spotLightShadows.value=G.state.spotShadow,ze.rectAreaLights.value=G.state.rectArea,ze.ltc_1.value=G.state.rectAreaLTC1,ze.ltc_2.value=G.state.rectAreaLTC2,ze.pointLights.value=G.state.point,ze.pointLightShadows.value=G.state.pointShadow,ze.hemisphereLights.value=G.state.hemi,ze.directionalShadowMap.value=G.state.directionalShadowMap,ze.directionalShadowMatrix.value=G.state.directionalShadowMatrix,ze.spotShadowMap.value=G.state.spotShadowMap,ze.spotLightMatrix.value=G.state.spotLightMatrix,ze.spotLightMap.value=G.state.spotLightMap,ze.pointShadowMap.value=G.state.pointShadowMap,ze.pointShadowMatrix.value=G.state.pointShadowMatrix),Y.currentProgram=Ie,Y.uniformsList=null,Ie}function td(T){if(T.uniformsList===null){const I=T.currentProgram.getUniforms();T.uniformsList=ka.seqWithValue(I.seq,T.uniforms)}return T.uniformsList}function nd(T,I){const V=Oe.get(T);V.outputColorSpace=I.outputColorSpace,V.batching=I.batching,V.instancing=I.instancing,V.instancingColor=I.instancingColor,V.skinning=I.skinning,V.morphTargets=I.morphTargets,V.morphNormals=I.morphNormals,V.morphColors=I.morphColors,V.morphTargetsCount=I.morphTargetsCount,V.numClippingPlanes=I.numClippingPlanes,V.numIntersection=I.numClipIntersection,V.vertexAlphas=I.vertexAlphas,V.vertexTangents=I.vertexTangents,V.toneMapping=I.toneMapping}function B_(T,I,V,Y,G){I.isScene!==!0&&(I=we),A.resetTextureUnits();const pe=I.fog,Se=Y.isMeshStandardMaterial?I.environment:null,Le=w===null?g.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:hi,Ue=(Y.isMeshStandardMaterial?z:S).get(Y.envMap||Se),He=Y.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Ie=!!V.attributes.tangent&&(!!Y.normalMap||Y.anisotropy>0),ze=!!V.morphAttributes.position,mt=!!V.morphAttributes.normal,on=!!V.morphAttributes.color;let wt=Bi;Y.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(wt=g.toneMapping);const $n=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,at=$n!==void 0?$n.length:0,Ve=Oe.get(Y),Ol=p.state.lights;if(Z===!0&&(ue===!0||T!==M)){const gn=T===M&&Y.id===N;Fe.setState(Y,T,gn)}let dt=!1;Y.version===Ve.__version?(Ve.needsLights&&Ve.lightsStateVersion!==Ol.state.version||Ve.outputColorSpace!==Le||G.isBatchedMesh&&Ve.batching===!1||!G.isBatchedMesh&&Ve.batching===!0||G.isInstancedMesh&&Ve.instancing===!1||!G.isInstancedMesh&&Ve.instancing===!0||G.isSkinnedMesh&&Ve.skinning===!1||!G.isSkinnedMesh&&Ve.skinning===!0||G.isInstancedMesh&&Ve.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ve.instancingColor===!1&&G.instanceColor!==null||Ve.envMap!==Ue||Y.fog===!0&&Ve.fog!==pe||Ve.numClippingPlanes!==void 0&&(Ve.numClippingPlanes!==Fe.numPlanes||Ve.numIntersection!==Fe.numIntersection)||Ve.vertexAlphas!==He||Ve.vertexTangents!==Ie||Ve.morphTargets!==ze||Ve.morphNormals!==mt||Ve.morphColors!==on||Ve.toneMapping!==wt||be.isWebGL2===!0&&Ve.morphTargetsCount!==at)&&(dt=!0):(dt=!0,Ve.__version=Y.version);let qi=Ve.currentProgram;dt===!0&&(qi=ko(Y,I,G));let id=!1,bs=!1,Fl=!1;const It=qi.getUniforms(),$i=Ve.uniforms;if(ve.useProgram(qi.program)&&(id=!0,bs=!0,Fl=!0),Y.id!==N&&(N=Y.id,bs=!0),id||M!==T){It.setValue(H,"projectionMatrix",T.projectionMatrix),It.setValue(H,"viewMatrix",T.matrixWorldInverse);const gn=It.map.cameraPosition;gn!==void 0&&gn.setValue(H,Ce.setFromMatrixPosition(T.matrixWorld)),be.logarithmicDepthBuffer&&It.setValue(H,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(Y.isMeshPhongMaterial||Y.isMeshToonMaterial||Y.isMeshLambertMaterial||Y.isMeshBasicMaterial||Y.isMeshStandardMaterial||Y.isShaderMaterial)&&It.setValue(H,"isOrthographic",T.isOrthographicCamera===!0),M!==T&&(M=T,bs=!0,Fl=!0)}if(G.isSkinnedMesh){It.setOptional(H,G,"bindMatrix"),It.setOptional(H,G,"bindMatrixInverse");const gn=G.skeleton;gn&&(be.floatVertexTextures?(gn.boneTexture===null&&gn.computeBoneTexture(),It.setValue(H,"boneTexture",gn.boneTexture,A)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}G.isBatchedMesh&&(It.setOptional(H,G,"batchingTexture"),It.setValue(H,"batchingTexture",G._matricesTexture,A));const zl=V.morphAttributes;if((zl.position!==void 0||zl.normal!==void 0||zl.color!==void 0&&be.isWebGL2===!0)&&Be.update(G,V,qi),(bs||Ve.receiveShadow!==G.receiveShadow)&&(Ve.receiveShadow=G.receiveShadow,It.setValue(H,"receiveShadow",G.receiveShadow)),Y.isMeshGouraudMaterial&&Y.envMap!==null&&($i.envMap.value=Ue,$i.flipEnvMap.value=Ue.isCubeTexture&&Ue.isRenderTargetTexture===!1?-1:1),bs&&(It.setValue(H,"toneMappingExposure",g.toneMappingExposure),Ve.needsLights&&H_($i,Fl),pe&&Y.fog===!0&&fe.refreshFogUniforms($i,pe),fe.refreshMaterialUniforms($i,Y,$,W,ae),ka.upload(H,td(Ve),$i,A)),Y.isShaderMaterial&&Y.uniformsNeedUpdate===!0&&(ka.upload(H,td(Ve),$i,A),Y.uniformsNeedUpdate=!1),Y.isSpriteMaterial&&It.setValue(H,"center",G.center),It.setValue(H,"modelViewMatrix",G.modelViewMatrix),It.setValue(H,"normalMatrix",G.normalMatrix),It.setValue(H,"modelMatrix",G.matrixWorld),Y.isShaderMaterial||Y.isRawShaderMaterial){const gn=Y.uniformsGroups;for(let kl=0,V_=gn.length;kl<V_;kl++)if(be.isWebGL2){const rd=gn[kl];se.update(rd,qi),se.bind(rd,qi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return qi}function H_(T,I){T.ambientLightColor.needsUpdate=I,T.lightProbe.needsUpdate=I,T.directionalLights.needsUpdate=I,T.directionalLightShadows.needsUpdate=I,T.pointLights.needsUpdate=I,T.pointLightShadows.needsUpdate=I,T.spotLights.needsUpdate=I,T.spotLightShadows.needsUpdate=I,T.rectAreaLights.needsUpdate=I,T.hemisphereLights.needsUpdate=I}function G_(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(T,I,V){Oe.get(T.texture).__webglTexture=I,Oe.get(T.depthTexture).__webglTexture=V;const Y=Oe.get(T);Y.__hasExternalTextures=!0,Y.__hasExternalTextures&&(Y.__autoAllocateDepthBuffer=V===void 0,Y.__autoAllocateDepthBuffer||Ee.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),Y.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(T,I){const V=Oe.get(T);V.__webglFramebuffer=I,V.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(T,I=0,V=0){w=T,C=I,R=V;let Y=!0,G=null,pe=!1,Se=!1;if(T){const Ue=Oe.get(T);Ue.__useDefaultFramebuffer!==void 0?(ve.bindFramebuffer(H.FRAMEBUFFER,null),Y=!1):Ue.__webglFramebuffer===void 0?A.setupRenderTarget(T):Ue.__hasExternalTextures&&A.rebindTextures(T,Oe.get(T.texture).__webglTexture,Oe.get(T.depthTexture).__webglTexture);const He=T.texture;(He.isData3DTexture||He.isDataArrayTexture||He.isCompressedArrayTexture)&&(Se=!0);const Ie=Oe.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Ie[I])?G=Ie[I][V]:G=Ie[I],pe=!0):be.isWebGL2&&T.samples>0&&A.useMultisampledRTT(T)===!1?G=Oe.get(T).__webglMultisampledFramebuffer:Array.isArray(Ie)?G=Ie[V]:G=Ie,E.copy(T.viewport),B.copy(T.scissor),X=T.scissorTest}else E.copy(F).multiplyScalar($).floor(),B.copy(q).multiplyScalar($).floor(),X=K;if(ve.bindFramebuffer(H.FRAMEBUFFER,G)&&be.drawBuffers&&Y&&ve.drawBuffers(T,G),ve.viewport(E),ve.scissor(B),ve.setScissorTest(X),pe){const Ue=Oe.get(T.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ue.__webglTexture,V)}else if(Se){const Ue=Oe.get(T.texture),He=I||0;H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,Ue.__webglTexture,V||0,He)}N=-1},this.readRenderTargetPixels=function(T,I,V,Y,G,pe,Se){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Le=Oe.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Se!==void 0&&(Le=Le[Se]),Le){ve.bindFramebuffer(H.FRAMEBUFFER,Le);try{const Ue=T.texture,He=Ue.format,Ie=Ue.type;if(He!==On&&he.convert(He)!==H.getParameter(H.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ze=Ie===Ro&&(Ee.has("EXT_color_buffer_half_float")||be.isWebGL2&&Ee.has("EXT_color_buffer_float"));if(Ie!==Hi&&he.convert(Ie)!==H.getParameter(H.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Ie===Li&&(be.isWebGL2||Ee.has("OES_texture_float")||Ee.has("WEBGL_color_buffer_float")))&&!ze){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=T.width-Y&&V>=0&&V<=T.height-G&&H.readPixels(I,V,Y,G,he.convert(He),he.convert(Ie),pe)}finally{const Ue=w!==null?Oe.get(w).__webglFramebuffer:null;ve.bindFramebuffer(H.FRAMEBUFFER,Ue)}}},this.copyFramebufferToTexture=function(T,I,V=0){const Y=Math.pow(2,-V),G=Math.floor(I.image.width*Y),pe=Math.floor(I.image.height*Y);A.setTexture2D(I,0),H.copyTexSubImage2D(H.TEXTURE_2D,V,0,0,T.x,T.y,G,pe),ve.unbindTexture()},this.copyTextureToTexture=function(T,I,V,Y=0){const G=I.image.width,pe=I.image.height,Se=he.convert(V.format),Le=he.convert(V.type);A.setTexture2D(V,0),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,V.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,V.unpackAlignment),I.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,Y,T.x,T.y,G,pe,Se,Le,I.image.data):I.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,Y,T.x,T.y,I.mipmaps[0].width,I.mipmaps[0].height,Se,I.mipmaps[0].data):H.texSubImage2D(H.TEXTURE_2D,Y,T.x,T.y,Se,Le,I.image),Y===0&&V.generateMipmaps&&H.generateMipmap(H.TEXTURE_2D),ve.unbindTexture()},this.copyTextureToTexture3D=function(T,I,V,Y,G=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const pe=T.max.x-T.min.x+1,Se=T.max.y-T.min.y+1,Le=T.max.z-T.min.z+1,Ue=he.convert(Y.format),He=he.convert(Y.type);let Ie;if(Y.isData3DTexture)A.setTexture3D(Y,0),Ie=H.TEXTURE_3D;else if(Y.isDataArrayTexture||Y.isCompressedArrayTexture)A.setTexture2DArray(Y,0),Ie=H.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,Y.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,Y.unpackAlignment);const ze=H.getParameter(H.UNPACK_ROW_LENGTH),mt=H.getParameter(H.UNPACK_IMAGE_HEIGHT),on=H.getParameter(H.UNPACK_SKIP_PIXELS),wt=H.getParameter(H.UNPACK_SKIP_ROWS),$n=H.getParameter(H.UNPACK_SKIP_IMAGES),at=V.isCompressedTexture?V.mipmaps[G]:V.image;H.pixelStorei(H.UNPACK_ROW_LENGTH,at.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,at.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,T.min.x),H.pixelStorei(H.UNPACK_SKIP_ROWS,T.min.y),H.pixelStorei(H.UNPACK_SKIP_IMAGES,T.min.z),V.isDataTexture||V.isData3DTexture?H.texSubImage3D(Ie,G,I.x,I.y,I.z,pe,Se,Le,Ue,He,at.data):V.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),H.compressedTexSubImage3D(Ie,G,I.x,I.y,I.z,pe,Se,Le,Ue,at.data)):H.texSubImage3D(Ie,G,I.x,I.y,I.z,pe,Se,Le,Ue,He,at),H.pixelStorei(H.UNPACK_ROW_LENGTH,ze),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,mt),H.pixelStorei(H.UNPACK_SKIP_PIXELS,on),H.pixelStorei(H.UNPACK_SKIP_ROWS,wt),H.pixelStorei(H.UNPACK_SKIP_IMAGES,$n),G===0&&Y.generateMipmaps&&H.generateMipmap(Ie),ve.unbindTexture()},this.initTexture=function(T){T.isCubeTexture?A.setTextureCube(T,0):T.isData3DTexture?A.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?A.setTexture2DArray(T,0):A.setTexture2D(T,0),ve.unbindTexture()},this.resetState=function(){C=0,R=0,w=null,ve.reset(),P.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ai}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===Vf?"display-p3":"srgb",n.unpackColorSpace=Je.workingColorSpace===Ul?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Dt?dr:h_}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===dr?Dt:hi}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class I1 extends F_{}I1.prototype.isWebGL1Renderer=!0;class qf{constructor(e,n=1,i=1e3){this.isFog=!0,this.name="",this.color=new Ke(e),this.near=n,this.far=i}clone(){return new qf(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class O1 extends Gt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n}}class $f extends mi{constructor(e=1,n=1,i=1,r=32,s=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:n,height:i,radialSegments:r,heightSegments:s,openEnded:o,thetaStart:a,thetaLength:l};const u=this;r=Math.floor(r),s=Math.floor(s);const f=[],d=[],h=[],m=[];let v=0;const x=[],p=i/2;let c=0;_(),o===!1&&(e>0&&g(!0),n>0&&g(!1)),this.setIndex(f),this.setAttribute("position",new Vt(d,3)),this.setAttribute("normal",new Vt(h,3)),this.setAttribute("uv",new Vt(m,2));function _(){const y=new U,C=new U;let R=0;const w=(n-e)/i;for(let N=0;N<=s;N++){const M=[],E=N/s,B=E*(n-e)+e;for(let X=0;X<=r;X++){const Q=X/r,b=Q*l+a,k=Math.sin(b),W=Math.cos(b);C.x=B*k,C.y=-E*i+p,C.z=B*W,d.push(C.x,C.y,C.z),y.set(k,w,W).normalize(),h.push(y.x,y.y,y.z),m.push(Q,1-E),M.push(v++)}x.push(M)}for(let N=0;N<r;N++)for(let M=0;M<s;M++){const E=x[M][N],B=x[M+1][N],X=x[M+1][N+1],Q=x[M][N+1];f.push(E,B,Q),f.push(B,X,Q),R+=6}u.addGroup(c,R,0),c+=R}function g(y){const C=v,R=new Ne,w=new U;let N=0;const M=y===!0?e:n,E=y===!0?1:-1;for(let X=1;X<=r;X++)d.push(0,p*E,0),h.push(0,E,0),m.push(.5,.5),v++;const B=v;for(let X=0;X<=r;X++){const b=X/r*l+a,k=Math.cos(b),W=Math.sin(b);w.x=M*W,w.y=p*E,w.z=M*k,d.push(w.x,w.y,w.z),h.push(0,E,0),R.x=k*.5+.5,R.y=W*.5*E+.5,m.push(R.x,R.y),v++}for(let X=0;X<r;X++){const Q=C+X,b=B+X;y===!0?f.push(b,b+1,Q):f.push(b+1,b,Q),N+=3}u.addGroup(c,N,y===!0?1:2),c+=N}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new $f(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Kf extends $f{constructor(e=1,n=1,i=32,r=1,s=!1,o=0,a=Math.PI*2){super(0,e,n,i,r,s,o,a),this.type="ConeGeometry",this.parameters={radius:e,height:n,radialSegments:i,heightSegments:r,openEnded:s,thetaStart:o,thetaLength:a}}static fromJSON(e){return new Kf(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class os extends mi{constructor(e=1,n=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},n=Math.max(3,Math.floor(n)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let u=0;const f=[],d=new U,h=new U,m=[],v=[],x=[],p=[];for(let c=0;c<=i;c++){const _=[],g=c/i;let y=0;c===0&&o===0?y=.5/n:c===i&&l===Math.PI&&(y=-.5/n);for(let C=0;C<=n;C++){const R=C/n;d.x=-e*Math.cos(r+R*s)*Math.sin(o+g*a),d.y=e*Math.cos(o+g*a),d.z=e*Math.sin(r+R*s)*Math.sin(o+g*a),v.push(d.x,d.y,d.z),h.copy(d).normalize(),x.push(h.x,h.y,h.z),p.push(R+y,1-g),_.push(u++)}f.push(_)}for(let c=0;c<i;c++)for(let _=0;_<n;_++){const g=f[c][_+1],y=f[c][_],C=f[c+1][_],R=f[c+1][_+1];(c!==0||o>0)&&m.push(g,y,R),(c!==i-1||l<Math.PI)&&m.push(y,C,R)}this.setIndex(m),this.setAttribute("position",new Vt(v,3)),this.setAttribute("normal",new Vt(x,3)),this.setAttribute("uv",new Vt(p,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new os(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Gn extends Fo{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ke(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ke(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=p_,this.normalScale=new Ne(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}const Np={enabled:!1,files:{},add:function(t,e){this.enabled!==!1&&(this.files[t]=e)},get:function(t){if(this.enabled!==!1)return this.files[t]},remove:function(t){delete this.files[t]},clear:function(){this.files={}}};class F1{constructor(e,n,i){const r=this;let s=!1,o=0,a=0,l;const u=[];this.onStart=void 0,this.onLoad=e,this.onProgress=n,this.onError=i,this.itemStart=function(f){a++,s===!1&&r.onStart!==void 0&&r.onStart(f,o,a),s=!0},this.itemEnd=function(f){o++,r.onProgress!==void 0&&r.onProgress(f,o,a),o===a&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(f){r.onError!==void 0&&r.onError(f)},this.resolveURL=function(f){return l?l(f):f},this.setURLModifier=function(f){return l=f,this},this.addHandler=function(f,d){return u.push(f,d),this},this.removeHandler=function(f){const d=u.indexOf(f);return d!==-1&&u.splice(d,2),this},this.getHandler=function(f){for(let d=0,h=u.length;d<h;d+=2){const m=u[d],v=u[d+1];if(m.global&&(m.lastIndex=0),m.test(f))return v}return null}}}const z1=new F1;class Zf{constructor(e){this.manager=e!==void 0?e:z1,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,n){const i=this;return new Promise(function(r,s){i.load(e,r,n,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}Zf.DEFAULT_MATERIAL_NAME="__DEFAULT";class k1 extends Zf{constructor(e){super(e)}load(e,n,i,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,o=Np.get(e);if(o!==void 0)return s.manager.itemStart(e),setTimeout(function(){n&&n(o),s.manager.itemEnd(e)},0),o;const a=Po("img");function l(){f(),Np.add(e,this),n&&n(this),s.manager.itemEnd(e)}function u(d){f(),r&&r(d),s.manager.itemError(e),s.manager.itemEnd(e)}function f(){a.removeEventListener("load",l,!1),a.removeEventListener("error",u,!1)}return a.addEventListener("load",l,!1),a.addEventListener("error",u,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),s.manager.itemStart(e),a.src=e,a}}class B1 extends Zf{constructor(e){super(e)}load(e,n,i,r){const s=new sn,o=new k1(this.manager);return o.setCrossOrigin(this.crossOrigin),o.setPath(this.path),o.load(e,function(a){s.image=a,s.needsUpdate=!0,n!==void 0&&n(s)},i,r),s}}class Qf extends Gt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ke(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),n}}const Hu=new yt,Ip=new U,Op=new U;class z_{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ne(512,512),this.map=null,this.mapPass=null,this.matrix=new yt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new jf,this._frameExtents=new Ne(1,1),this._viewportCount=1,this._viewports=[new ot(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;Ip.setFromMatrixPosition(e.matrixWorld),n.position.copy(Ip),Op.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(Op),n.updateMatrixWorld(),Hu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Hu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Hu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Fp=new yt,Ws=new U,Gu=new U;class H1 extends z_{constructor(){super(new cn(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Ne(4,2),this._viewportCount=6,this._viewports=[new ot(2,1,1,1),new ot(0,1,1,1),new ot(3,1,1,1),new ot(1,1,1,1),new ot(3,0,1,1),new ot(1,0,1,1)],this._cubeDirections=[new U(1,0,0),new U(-1,0,0),new U(0,0,1),new U(0,0,-1),new U(0,1,0),new U(0,-1,0)],this._cubeUps=[new U(0,1,0),new U(0,1,0),new U(0,1,0),new U(0,1,0),new U(0,0,1),new U(0,0,-1)]}updateMatrices(e,n=0){const i=this.camera,r=this.matrix,s=e.distance||i.far;s!==i.far&&(i.far=s,i.updateProjectionMatrix()),Ws.setFromMatrixPosition(e.matrixWorld),i.position.copy(Ws),Gu.copy(i.position),Gu.add(this._cubeDirections[n]),i.up.copy(this._cubeUps[n]),i.lookAt(Gu),i.updateMatrixWorld(),r.makeTranslation(-Ws.x,-Ws.y,-Ws.z),Fp.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Fp)}}class wa extends Qf{constructor(e,n,i=0,r=2){super(e,n),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=r,this.shadow=new H1}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,n){return super.copy(e,n),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class G1 extends z_{constructor(){super(new L_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class V1 extends Qf{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Gt.DEFAULT_UP),this.updateMatrix(),this.target=new Gt,this.shadow=new G1}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class W1 extends Qf{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}class X1{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=zp(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const n=zp();e=(n-this.oldTime)/1e3,this.oldTime=n,this.elapsedTime+=e}return e}}function zp(){return(typeof performance>"u"?Date:performance).now()}class kp{constructor(e=1,n=0,i=0){return this.radius=e,this.phi=n,this.theta=i,this}set(e,n,i){return this.radius=e,this.phi=n,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,n,i){return this.radius=Math.sqrt(e*e+n*n+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Ht(n/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Hf}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Hf);const Bp={type:"change"},Vu={type:"start"},Hp={type:"end"},Aa=new y_,Gp=new Ti,j1=Math.cos(70*Py.DEG2RAD);class Y1 extends Tr{constructor(e,n){super(),this.object=e,this.domElement=n,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new U,this.cursor=new U,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ar.ROTATE,MIDDLE:Ar.DOLLY,RIGHT:Ar.PAN},this.touches={ONE:Rr.ROTATE,TWO:Rr.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(P){P.addEventListener("keydown",Ae),this._domElementKeyEvents=P},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Ae),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(Bp),i.update(),s=r.NONE},this.update=function(){const P=new U,se=new xr().setFromUnitVectors(e.up,new U(0,1,0)),ye=se.clone().invert(),ge=new U,te=new xr,L=new U,oe=2*Math.PI;return function(Pe=null){const Te=i.object.position;P.copy(Te).sub(i.target),P.applyQuaternion(se),a.setFromVector3(P),i.autoRotate&&s===r.NONE&&X(E(Pe)),i.enableDamping?(a.theta+=l.theta*i.dampingFactor,a.phi+=l.phi*i.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let Xe=i.minAzimuthAngle,je=i.maxAzimuthAngle;isFinite(Xe)&&isFinite(je)&&(Xe<-Math.PI?Xe+=oe:Xe>Math.PI&&(Xe-=oe),je<-Math.PI?je+=oe:je>Math.PI&&(je-=oe),Xe<=je?a.theta=Math.max(Xe,Math.min(je,a.theta)):a.theta=a.theta>(Xe+je)/2?Math.max(Xe,a.theta):Math.min(je,a.theta)),a.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,a.phi)),a.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(f,i.dampingFactor):i.target.add(f),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor),i.zoomToCursor&&R||i.object.isOrthographicCamera?a.radius=F(a.radius):a.radius=F(a.radius*u),P.setFromSpherical(a),P.applyQuaternion(ye),Te.copy(i.target).add(P),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,f.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),f.set(0,0,0));let ft=!1;if(i.zoomToCursor&&R){let pt=null;if(i.object.isPerspectiveCamera){const $e=P.length();pt=F($e*u);const _t=$e-pt;i.object.position.addScaledVector(y,_t),i.object.updateMatrixWorld()}else if(i.object.isOrthographicCamera){const $e=new U(C.x,C.y,0);$e.unproject(i.object),i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/u)),i.object.updateProjectionMatrix(),ft=!0;const _t=new U(C.x,C.y,0);_t.unproject(i.object),i.object.position.sub(_t).add($e),i.object.updateMatrixWorld(),pt=P.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;pt!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(pt).add(i.object.position):(Aa.origin.copy(i.object.position),Aa.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(Aa.direction))<j1?e.lookAt(i.target):(Gp.setFromNormalAndCoplanarPoint(i.object.up,i.target),Aa.intersectPlane(Gp,i.target))))}else i.object.isOrthographicCamera&&(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/u)),i.object.updateProjectionMatrix(),ft=!0);return u=1,R=!1,ft||ge.distanceToSquared(i.object.position)>o||8*(1-te.dot(i.object.quaternion))>o||L.distanceToSquared(i.target)>0?(i.dispatchEvent(Bp),ge.copy(i.object.position),te.copy(i.object.quaternion),L.copy(i.target),!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",Ze),i.domElement.removeEventListener("pointerdown",A),i.domElement.removeEventListener("pointercancel",z),i.domElement.removeEventListener("wheel",re),i.domElement.removeEventListener("pointermove",S),i.domElement.removeEventListener("pointerup",z),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",Ae),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new kp,l=new kp;let u=1;const f=new U,d=new Ne,h=new Ne,m=new Ne,v=new Ne,x=new Ne,p=new Ne,c=new Ne,_=new Ne,g=new Ne,y=new U,C=new Ne;let R=!1;const w=[],N={};let M=!1;function E(P){return P!==null?2*Math.PI/60*i.autoRotateSpeed*P:2*Math.PI/60/60*i.autoRotateSpeed}function B(P){const se=Math.abs(P*.01);return Math.pow(.95,i.zoomSpeed*se)}function X(P){l.theta-=P}function Q(P){l.phi-=P}const b=function(){const P=new U;return function(ye,ge){P.setFromMatrixColumn(ge,0),P.multiplyScalar(-ye),f.add(P)}}(),k=function(){const P=new U;return function(ye,ge){i.screenSpacePanning===!0?P.setFromMatrixColumn(ge,1):(P.setFromMatrixColumn(ge,0),P.crossVectors(i.object.up,P)),P.multiplyScalar(ye),f.add(P)}}(),W=function(){const P=new U;return function(ye,ge){const te=i.domElement;if(i.object.isPerspectiveCamera){const L=i.object.position;P.copy(L).sub(i.target);let oe=P.length();oe*=Math.tan(i.object.fov/2*Math.PI/180),b(2*ye*oe/te.clientHeight,i.object.matrix),k(2*ge*oe/te.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(b(ye*(i.object.right-i.object.left)/i.object.zoom/te.clientWidth,i.object.matrix),k(ge*(i.object.top-i.object.bottom)/i.object.zoom/te.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function $(P){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?u/=P:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function D(P){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?u*=P:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function O(P,se){if(!i.zoomToCursor)return;R=!0;const ye=i.domElement.getBoundingClientRect(),ge=P-ye.left,te=se-ye.top,L=ye.width,oe=ye.height;C.x=ge/L*2-1,C.y=-(te/oe)*2+1,y.set(C.x,C.y,1).unproject(i.object).sub(i.object.position).normalize()}function F(P){return Math.max(i.minDistance,Math.min(i.maxDistance,P))}function q(P){d.set(P.clientX,P.clientY)}function K(P){O(P.clientX,P.clientX),c.set(P.clientX,P.clientY)}function j(P){v.set(P.clientX,P.clientY)}function Z(P){h.set(P.clientX,P.clientY),m.subVectors(h,d).multiplyScalar(i.rotateSpeed);const se=i.domElement;X(2*Math.PI*m.x/se.clientHeight),Q(2*Math.PI*m.y/se.clientHeight),d.copy(h),i.update()}function ue(P){_.set(P.clientX,P.clientY),g.subVectors(_,c),g.y>0?$(B(g.y)):g.y<0&&D(B(g.y)),c.copy(_),i.update()}function ae(P){x.set(P.clientX,P.clientY),p.subVectors(x,v).multiplyScalar(i.panSpeed),W(p.x,p.y),v.copy(x),i.update()}function de(P){O(P.clientX,P.clientY),P.deltaY<0?D(B(P.deltaY)):P.deltaY>0&&$(B(P.deltaY)),i.update()}function Re(P){let se=!1;switch(P.code){case i.keys.UP:P.ctrlKey||P.metaKey||P.shiftKey?Q(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(0,i.keyPanSpeed),se=!0;break;case i.keys.BOTTOM:P.ctrlKey||P.metaKey||P.shiftKey?Q(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(0,-i.keyPanSpeed),se=!0;break;case i.keys.LEFT:P.ctrlKey||P.metaKey||P.shiftKey?X(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(i.keyPanSpeed,0),se=!0;break;case i.keys.RIGHT:P.ctrlKey||P.metaKey||P.shiftKey?X(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(-i.keyPanSpeed,0),se=!0;break}se&&(P.preventDefault(),i.update())}function Ce(P){if(w.length===1)d.set(P.pageX,P.pageY);else{const se=he(P),ye=.5*(P.pageX+se.x),ge=.5*(P.pageY+se.y);d.set(ye,ge)}}function we(P){if(w.length===1)v.set(P.pageX,P.pageY);else{const se=he(P),ye=.5*(P.pageX+se.x),ge=.5*(P.pageY+se.y);v.set(ye,ge)}}function Ge(P){const se=he(P),ye=P.pageX-se.x,ge=P.pageY-se.y,te=Math.sqrt(ye*ye+ge*ge);c.set(0,te)}function H(P){i.enableZoom&&Ge(P),i.enablePan&&we(P)}function Pt(P){i.enableZoom&&Ge(P),i.enableRotate&&Ce(P)}function Ee(P){if(w.length==1)h.set(P.pageX,P.pageY);else{const ye=he(P),ge=.5*(P.pageX+ye.x),te=.5*(P.pageY+ye.y);h.set(ge,te)}m.subVectors(h,d).multiplyScalar(i.rotateSpeed);const se=i.domElement;X(2*Math.PI*m.x/se.clientHeight),Q(2*Math.PI*m.y/se.clientHeight),d.copy(h)}function be(P){if(w.length===1)x.set(P.pageX,P.pageY);else{const se=he(P),ye=.5*(P.pageX+se.x),ge=.5*(P.pageY+se.y);x.set(ye,ge)}p.subVectors(x,v).multiplyScalar(i.panSpeed),W(p.x,p.y),v.copy(x)}function ve(P){const se=he(P),ye=P.pageX-se.x,ge=P.pageY-se.y,te=Math.sqrt(ye*ye+ge*ge);_.set(0,te),g.set(0,Math.pow(_.y/c.y,i.zoomSpeed)),$(g.y),c.copy(_);const L=(P.pageX+se.x)*.5,oe=(P.pageY+se.y)*.5;O(L,oe)}function tt(P){i.enableZoom&&ve(P),i.enablePan&&be(P)}function Oe(P){i.enableZoom&&ve(P),i.enableRotate&&Ee(P)}function A(P){i.enabled!==!1&&(w.length===0&&(i.domElement.setPointerCapture(P.pointerId),i.domElement.addEventListener("pointermove",S),i.domElement.addEventListener("pointerup",z)),Be(P),P.pointerType==="touch"?Fe(P):ie(P))}function S(P){i.enabled!==!1&&(P.pointerType==="touch"?J(P):ee(P))}function z(P){De(P),w.length===0&&(i.domElement.releasePointerCapture(P.pointerId),i.domElement.removeEventListener("pointermove",S),i.domElement.removeEventListener("pointerup",z)),i.dispatchEvent(Hp),s=r.NONE}function ie(P){let se;switch(P.button){case 0:se=i.mouseButtons.LEFT;break;case 1:se=i.mouseButtons.MIDDLE;break;case 2:se=i.mouseButtons.RIGHT;break;default:se=-1}switch(se){case Ar.DOLLY:if(i.enableZoom===!1)return;K(P),s=r.DOLLY;break;case Ar.ROTATE:if(P.ctrlKey||P.metaKey||P.shiftKey){if(i.enablePan===!1)return;j(P),s=r.PAN}else{if(i.enableRotate===!1)return;q(P),s=r.ROTATE}break;case Ar.PAN:if(P.ctrlKey||P.metaKey||P.shiftKey){if(i.enableRotate===!1)return;q(P),s=r.ROTATE}else{if(i.enablePan===!1)return;j(P),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Vu)}function ee(P){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;Z(P);break;case r.DOLLY:if(i.enableZoom===!1)return;ue(P);break;case r.PAN:if(i.enablePan===!1)return;ae(P);break}}function re(P){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(P.preventDefault(),i.dispatchEvent(Vu),de(xe(P)),i.dispatchEvent(Hp))}function xe(P){const se=P.deltaMode,ye={clientX:P.clientX,clientY:P.clientY,deltaY:P.deltaY};switch(se){case 1:ye.deltaY*=16;break;case 2:ye.deltaY*=100;break}return P.ctrlKey&&!M&&(ye.deltaY*=10),ye}function fe(P){P.key==="Control"&&(M=!0,document.addEventListener("keyup",_e,{passive:!0,capture:!0}))}function _e(P){P.key==="Control"&&(M=!1,document.removeEventListener("keyup",_e,{passive:!0,capture:!0}))}function Ae(P){i.enabled===!1||i.enablePan===!1||Re(P)}function Fe(P){switch(Me(P),w.length){case 1:switch(i.touches.ONE){case Rr.ROTATE:if(i.enableRotate===!1)return;Ce(P),s=r.TOUCH_ROTATE;break;case Rr.PAN:if(i.enablePan===!1)return;we(P),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Rr.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;H(P),s=r.TOUCH_DOLLY_PAN;break;case Rr.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;Pt(P),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Vu)}function J(P){switch(Me(P),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;Ee(P),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;be(P),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;tt(P),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;Oe(P),i.update();break;default:s=r.NONE}}function Ze(P){i.enabled!==!1&&P.preventDefault()}function Be(P){w.push(P.pointerId)}function De(P){delete N[P.pointerId];for(let se=0;se<w.length;se++)if(w[se]==P.pointerId){w.splice(se,1);return}}function Me(P){let se=N[P.pointerId];se===void 0&&(se=new Ne,N[P.pointerId]=se),se.set(P.pageX,P.pageY)}function he(P){const se=P.pointerId===w[0]?w[1]:w[0];return N[se]}i.domElement.addEventListener("contextmenu",Ze),i.domElement.addEventListener("pointerdown",A),i.domElement.addEventListener("pointercancel",z),i.domElement.addEventListener("wheel",re,{passive:!1}),document.addEventListener("keydown",fe,{passive:!0,capture:!0}),this.update()}}console.log.bind();window.onload=()=>{document.querySelector(".webgl");const t=new O1,e=new qf("#262837",0,15);t.fog=e;const n=new B1,i=n.load("./static/textures/door/color.jpg"),r=n.load("./static/textures/door/alpha.jpg"),s=n.load("./static/textures/door/ambientOcclusion.jpg"),o=n.load("./static/textures/door/height.jpg"),a=n.load("./static/textures/door/normal.jpg"),l=n.load("./static/textures/door/metalness.jpg"),u=n.load("./static/textures/door/roughness.jpg"),f=n.load("./static/textures/bricks/color.jpg"),d=n.load("./static/textures/bricks/ambientOcclusion.jpg"),h=n.load("./static/textures/bricks/normal.jpg"),m=n.load("./static/textures/bricks/roughness.jpg"),v=n.load("./static/textures/grass/color.jpg"),x=n.load("./static/textures/grass/ambientOcclusion.jpg"),p=n.load("./static/textures/grass/normal.jpg"),c=n.load("./static/textures/grass/roughness.jpg");v.repeat.set(8,8),x.repeat.set(8,8),p.repeat.set(8,8),c.repeat.set(8,8),v.wrapS=bn,x.wrapS=bn,p.wrapS=bn,c.wrapS=bn,v.wrapT=bn,x.wrapT=bn,p.wrapT=bn,c.wrapT=bn;const _=new Lo(18.5,18.5);new Gn({color:"green"});const g=new ss;t.add(g);const y=new bt(new yr(4,2.5,4),new Gn({map:f,aoMap:d,normalMap:h,roughnessMap:m}));y.geometry.setAttribute("uv2",new Vt(y.geometry.attributes.uv.array,2)),y.position.set(0,2.5/2,0),g.add(y);const C=new bt(new Kf(3.5,1,4),new Gn({color:"red"}));C.position.y=2.5+.5,C.rotation.y=Math.PI*.5/2,g.add(C);const R=new bt(new Lo(2.2,2.2,100,100),new Gn({map:i,transparent:!0,alphaMap:r,aoMap:s,displacementMap:o,displacementScale:.1,normalMap:a,metalnessMap:l,roughnessMap:u}));R.geometry.setAttribute("uv2",new Vt(R.geometry.attributes.uv.array,2)),R.position.set(0,1,2+.01),g.add(R);const w=new bt(new os(1,16,16),new Gn({color:"green"}));w.scale.set(.5,.5,.5),w.position.set(.8,.2,2.2);const N=new bt(new os(1,16,16),new Gn({color:"green"}));N.scale.set(.25,.25,.25),N.position.set(1.4,.1,2.1);const M=new bt(new os(1,16,16),new Gn({color:"green"}));M.scale.set(.4,.4,.4),M.position.set(-.8,.1,2.2);const E=new bt(new os(1,16,16),new Gn({color:"green"}));E.scale.set(.15,.15,.15),E.position.set(-1,.05,2.6),g.add(w,N,M,E);const B=new ss;t.add(B);const X=new yr(.6,.8,.2),Q=new Gn({color:"grey"});for(let ae=0;ae<50;ae++){const de=new bt(X,Q),Re=Math.random()*Math.PI*2,Ce=3+Math.random()*6,we=Math.sin(Re)*Ce,Ge=Math.cos(Re)*Ce;de.position.set(we,.3,Ge),de.rotation.y=(Math.random()-.5)*1,de.rotation.z=(Math.random()-.5)*.4,de.castShadow=!0,B.add(de)}const b=new bt(_,new Gn({map:v,aoMap:x,normalMap:p,roughnessMap:c}));b.geometry.setAttribute("uv2",new Vt(b.geometry.attributes.uv.array,2)),b.rotation.x=-(Math.PI*.5),b.receiveShadow=!0,t.add(b);const k=new W1("#b9d5ff",.12);t.add(k);const W=new V1("#b9d5ff",.12);W.position.set(4,5,-2),t.add(W);const $=new wa("#ff7d46",2,7);$.position.set(0,2.2,2.7),t.add($);const D=new wa("#ff00ff",2,3);t.add(D);const O=new wa("#00ffff",2,3);t.add(O);const F=new wa("#ffff00",2,3);t.add(F);const q=new cn(75,window.innerWidth/window.innerHeight);q.position.set(30,4,30),t.add(q);const K=new F_;K.setSize(window.innerWidth,window.innerHeight),K.setClearColor("#262837"),document.body.appendChild(K.domElement);const j=new Y1(q,K.domElement);j.enableDamping=!0,K.shadowMap.enabled=!0,K.shadowMap.type=i_,W.castShadow=!0,$.castShadow=!0,D.castShadow=!0,O.castShadow=!0,F.castShadow=!0,y.castShadow=!0,w.castShadow=!0,N.castShadow=!0,M.castShadow=!0,E.castShadow=!0,$.shadow.mapSize.width=256,$.shadow.mapSize.height=256,$.shadow.camera.far=7,D.shadow.mapSize.width=256,D.shadow.mapSize.height=256,D.shadow.camera.far=7,O.shadow.mapSize.width=256,O.shadow.mapSize.height=256,O.shadow.camera.far=7,F.shadow.mapSize.width=256,F.shadow.mapSize.height=256,F.shadow.camera.far=7;const Z=new X1;function ue(){const ae=Z.getElapsedTime(),de=ae*.5;D.position.x=Math.cos(de)*4,D.position.z=Math.sin(de)*4,D.position.y=Math.sin(ae*3);const Re=-ae*.32;O.position.x=Math.cos(Re)*5,O.position.z=Math.sin(Re)*5,O.position.y=Math.sin(ae*3);const Ce=-ae*.18;F.position.x=Math.cos(Ce)*(7+Math.sin(ae*.32)),F.position.z=Math.sin(Ce)*(7+Math.sin(ae*.5)),F.position.y=Math.sin(ae*5),ae<9.6&&(q.position.z>=6?(q.position.z=30-ae*8,q.position.x=30-ae*8):(q.position.x=Math.sin(ae-7)*9,q.position.z=-(Math.cos(ae-7)*7))),j.update(),K.render(t,q),requestAnimationFrame(ue)}ue()};function q1(){return $s.jsx($s.Fragment,{children:$s.jsx("canvas",{className:"webgl"})})}Wu.createRoot(document.getElementById("root")).render($s.jsx(o0.StrictMode,{children:$s.jsx(q1,{})}));
